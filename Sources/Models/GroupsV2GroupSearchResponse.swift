...
public struct GroupsV2GroupSearchResponse: APIModel {
    ...
    public var results: [GroupsV2GroupV2Card]?
...
This is a long-held historical throwback to when we used to do paging with known total results. Those queries toasted our database, and we were left to hastily alter our endpoints and create backward- compatible shims, of which useTotalResults is one. */
    ...
    public init(hasMore: Bool? = nil, query: QueriesPagedQuery? = nil, replacementContinuationToken: String? = nil, results: [GroupsV2GroupV2Card]? = nil, totalResults: Int? = nil, useTotalResults: Bool? = nil) {
    ...
    public static func == (lhs: GroupsV2GroupSearchResponse, rhs: GroupsV2GroupSearchResponse) -> Bool {
