...
public struct DestinyDefinitionsMilestonesDestinyMilestoneActivityDefinition: APIModel {
...
If you care about the specific difficulty modes and variations, use the activities under "Variants". */
    public var conceptualActivityHash: Int?
...
If a Milestone could ever split the variants' active status conditionally, they should all have their own DestinyMilestoneActivityDefinition instead! The potential duplication will be worth it for the obviousness of processing and use. */
    public var variants: [String: DestinyDefinitionsMilestonesDestinyMilestoneActivityVariantDefinition]?

    public init(conceptualActivityHash: Int? = nil, variants: [String: DestinyDefinitionsMilestonesDestinyMilestoneActivityVariantDefinition]? = nil) {
        self.conceptualActivityHash = conceptualActivityHash
    ...
    public init(from decoder: Decoder) throws {
        ...
        conceptualActivityHash = try container.decodeIfPresent("conceptualActivityHash")
        variants = try container.decodeIfPresent("variants")
    }

    public func encode(to encoder: Encoder) throws {
        var container = encoder.container(keyedBy: StringCodingKey.self)

        try container.encodeIfPresent(conceptualActivityHash, forKey: "conceptualActivityHash")
        try container.encodeIfPresent(variants, forKey: "variants")
    }

    public static func == (lhs: DestinyDefinitionsMilestonesDestinyMilestoneActivityDefinition, rhs: DestinyDefinitionsMilestonesDestinyMilestoneActivityDefinition) -> Bool {
        guard lhs.conceptualActivityHash == rhs.conceptualActivityHash else { return false }
