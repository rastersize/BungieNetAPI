...
public struct DestinyRequestsActionsDestinyPostmasterTransferRequest: APIModel {
    ...
    public init(characterId: Int? = nil, itemId: Int? = nil, itemReferenceHash: Int? = nil, membershipType: Int? = nil, stackSize: Int? = nil) {
    ...
    public static func == (lhs: DestinyRequestsActionsDestinyPostmasterTransferRequest, rhs: DestinyRequestsActionsDestinyPostmasterTransferRequest) -> Bool {
