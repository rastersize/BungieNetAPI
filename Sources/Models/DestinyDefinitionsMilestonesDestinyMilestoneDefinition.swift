...
public struct DestinyDefinitionsMilestonesDestinyMilestoneDefinition: APIModel {
    ...
    public var activities: [DestinyDefinitionsMilestonesDestinyMilestoneChallengeActivityDefinition]?
    ...
    public var displayPreference: Int?
...
As of Forsaken (~September 2018), Quest-style Milestones are being removed for many types of activities. There will likely be further revisions to the Milestone concept in the future. */
    public var quests: [String: DestinyDefinitionsMilestonesDestinyMilestoneQuestDefinition]?
...
This is keyed by the Category's hash, which is only guaranteed to be unique within a given Milestone. */
    public var rewards: [String: DestinyDefinitionsMilestonesDestinyMilestoneRewardCategoryDefinition]?
    ...
    public var values: [String: DestinyDefinitionsMilestonesDestinyMilestoneValueDefinition]?
    ...
    public var vendors: [DestinyDefinitionsMilestonesDestinyMilestoneVendorDefinition]?
    ...
    public init(activities: [DestinyDefinitionsMilestonesDestinyMilestoneChallengeActivityDefinition]? = nil, defaultOrder: Int? = nil, displayPreference: Int? = nil, displayProperties: DestinyDefinitionsCommonDestinyDisplayPropertiesDefinition? = nil, explorePrioritizesActivityImage: Bool? = nil, friendlyName: String? = nil, hasPredictableDates: Bool? = nil, hash: Int? = nil, image: String? = nil, index: Int? = nil, isInGameMilestone: Bool? = nil, milestoneType: Int? = nil, quests: [String: DestinyDefinitionsMilestonesDestinyMilestoneQuestDefinition]? = nil, recruitable: Bool? = nil, redacted: Bool? = nil, rewards: [String: DestinyDefinitionsMilestonesDestinyMilestoneRewardCategoryDefinition]? = nil, showInExplorer: Bool? = nil, showInMilestones: Bool? = nil, values: [String: DestinyDefinitionsMilestonesDestinyMilestoneValueDefinition]? = nil, vendors: [DestinyDefinitionsMilestonesDestinyMilestoneVendorDefinition]? = nil, vendorsDisplayTitle: String? = nil) {
        self.activities = activities
        self.defaultOrder = defaultOrder
        self.displayPreference = displayPreference
        self.displayProperties = displayProperties
        self.explorePrioritizesActivityImage = explorePrioritizesActivityImage
        self.friendlyName = friendlyName
        self.hasPredictableDates = hasPredictableDates
        self.hash = hash
        self.image = image
        self.index = index
        self.isInGameMilestone = isInGameMilestone
        self.milestoneType = milestoneType
        self.quests = quests
        self.recruitable = recruitable
        self.redacted = redacted
        self.rewards = rewards
        self.showInExplorer = showInExplorer
        self.showInMilestones = showInMilestones
        self.values = values
        self.vendors = vendors
        self.vendorsDisplayTitle = vendorsDisplayTitle
    }
    ...
    public init(from decoder: Decoder) throws {
        ...
        defaultOrder = try container.decodeIfPresent("defaultOrder")
        displayPreference = try container.decodeIfPresent("displayPreference")
        displayProperties = try container.decodeIfPresent("displayProperties")
        explorePrioritizesActivityImage = try container.decodeIfPresent("explorePrioritizesActivityImage")
        friendlyName = try container.decodeIfPresent("friendlyName")
        hasPredictableDates = try container.decodeIfPresent("hasPredictableDates")
        ...
        isInGameMilestone = try container.decodeIfPresent("isInGameMilestone")
        milestoneType = try container.decodeIfPresent("milestoneType")
        quests = try container.decodeIfPresent("quests")
        recruitable = try container.decodeIfPresent("recruitable")
        redacted = try container.decodeIfPresent("redacted")
        rewards = try container.decodeIfPresent("rewards")
        showInExplorer = try container.decodeIfPresent("showInExplorer")
        showInMilestones = try container.decodeIfPresent("showInMilestones")
        values = try container.decodeIfPresent("values")
        vendors = try container.decodeArrayIfPresent("vendors")
        vendorsDisplayTitle = try container.decodeIfPresent("vendorsDisplayTitle")
    }
    ...
    public func encode(to encoder: Encoder) throws {
        ...
        try container.encodeIfPresent(explorePrioritizesActivityImage, forKey: "explorePrioritizesActivityImage")
        try container.encodeIfPresent(friendlyName, forKey: "friendlyName")
        try container.encodeIfPresent(hasPredictableDates, forKey: "hasPredictableDates")
        try container.encodeIfPresent(hash, forKey: "hash")
        try container.encodeIfPresent(image, forKey: "image")
        try container.encodeIfPresent(index, forKey: "index")
        try container.encodeIfPresent(isInGameMilestone, forKey: "isInGameMilestone")
        try container.encodeIfPresent(milestoneType, forKey: "milestoneType")
        try container.encodeIfPresent(quests, forKey: "quests")
        try container.encodeIfPresent(recruitable, forKey: "recruitable")
        try container.encodeIfPresent(redacted, forKey: "redacted")
        try container.encodeIfPresent(rewards, forKey: "rewards")
        try container.encodeIfPresent(showInExplorer, forKey: "showInExplorer")
        try container.encodeIfPresent(showInMilestones, forKey: "showInMilestones")
        try container.encodeIfPresent(values, forKey: "values")
        try container.encodeIfPresent(vendors, forKey: "vendors")
        try container.encodeIfPresent(vendorsDisplayTitle, forKey: "vendorsDisplayTitle")
    }

    public static func == (lhs: DestinyDefinitionsMilestonesDestinyMilestoneDefinition, rhs: DestinyDefinitionsMilestonesDestinyMilestoneDefinition) -> Bool {
        guard lhs.activities == rhs.activities else { return false }
        guard lhs.defaultOrder == rhs.defaultOrder else { return false }
        guard lhs.displayPreference == rhs.displayPreference else { return false }
        guard lhs.displayProperties == rhs.displayProperties else { return false }
        guard lhs.explorePrioritizesActivityImage == rhs.explorePrioritizesActivityImage else { return false }
        guard lhs.friendlyName == rhs.friendlyName else { return false }
        guard lhs.hasPredictableDates == rhs.hasPredictableDates else { return false }
        guard lhs.hash == rhs.hash else { return false }
        guard lhs.image == rhs.image else { return false }
        guard lhs.index == rhs.index else { return false }
        guard lhs.isInGameMilestone == rhs.isInGameMilestone else { return false }
        guard lhs.milestoneType == rhs.milestoneType else { return false }
        guard lhs.quests == rhs.quests else { return false }
        guard lhs.recruitable == rhs.recruitable else { return false }
        guard lhs.redacted == rhs.redacted else { return false }
        guard lhs.rewards == rhs.rewards else { return false }
        guard lhs.showInExplorer == rhs.showInExplorer else { return false }
        guard lhs.showInMilestones == rhs.showInMilestones else { return false }
        guard lhs.values == rhs.values else { return false }
        guard lhs.vendors == rhs.vendors else { return false }
        guard lhs.vendorsDisplayTitle == rhs.vendorsDisplayTitle else { return false }
        return true
    }
}
