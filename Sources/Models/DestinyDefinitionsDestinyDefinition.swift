...
public struct DestinyDefinitionsDestinyDefinition: APIModel {
...
When entities refer to each other in Destiny content, it is this hash that they are referring to. */
    ...
    public static func == (lhs: DestinyDefinitionsDestinyDefinition, rhs: DestinyDefinitionsDestinyDefinition) -> Bool {
