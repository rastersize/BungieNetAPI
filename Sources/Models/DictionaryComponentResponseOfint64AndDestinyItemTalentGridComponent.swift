...
public struct DictionaryComponentResponseOfint64AndDestinyItemTalentGridComponent: APIModel {
    ...
    public static func == (lhs: DictionaryComponentResponseOfint64AndDestinyItemTalentGridComponent, rhs: DictionaryComponentResponseOfint64AndDestinyItemTalentGridComponent) -> Bool {
