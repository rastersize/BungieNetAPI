...
public struct DestinyDefinitionsDestinyStatDefinition: APIModel {
...
For instance, the Light stat in Destiny 1 was a computed stat. */
    public var hasComputedBlock: Bool?
...
When entities refer to each other in Destiny content, it is this hash that they are referring to. */
    ...
    public var statCategory: Int?

    public init(aggregationType: Int? = nil, displayProperties: DestinyDefinitionsCommonDestinyDisplayPropertiesDefinition? = nil, hasComputedBlock: Bool? = nil, hash: Int? = nil, index: Int? = nil, redacted: Bool? = nil, statCategory: Int? = nil) {
        self.aggregationType = aggregationType
        self.displayProperties = displayProperties
        self.hasComputedBlock = hasComputedBlock
        self.hash = hash
        self.index = index
    ...
    public init(from decoder: Decoder) throws {
        ...
        aggregationType = try container.decodeIfPresent("aggregationType")
        displayProperties = try container.decodeIfPresent("displayProperties")
        hasComputedBlock = try container.decodeIfPresent("hasComputedBlock")
        ...
        statCategory = try container.decodeIfPresent("statCategory")
    }
    ...
    public func encode(to encoder: Encoder) throws {
        ...
        try container.encodeIfPresent(hasComputedBlock, forKey: "hasComputedBlock")
        try container.encodeIfPresent(hash, forKey: "hash")
        try container.encodeIfPresent(index, forKey: "index")
        try container.encodeIfPresent(redacted, forKey: "redacted")
        try container.encodeIfPresent(statCategory, forKey: "statCategory")
    }

    public static func == (lhs: DestinyDefinitionsDestinyStatDefinition, rhs: DestinyDefinitionsDestinyStatDefinition) -> Bool {
        guard lhs.aggregationType == rhs.aggregationType else { return false }
        guard lhs.displayProperties == rhs.displayProperties else { return false }
        guard lhs.hasComputedBlock == rhs.hasComputedBlock else { return false }
        guard lhs.hash == rhs.hash else { return false }
        guard lhs.index == rhs.index else { return false }
        guard lhs.redacted == rhs.redacted else { return false }
        guard lhs.statCategory == rhs.statCategory else { return false }
        return true
    }
}
