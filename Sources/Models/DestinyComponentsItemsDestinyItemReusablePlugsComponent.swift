...
public struct DestinyComponentsItemsDestinyItemReusablePlugsComponent: APIModel {
 ...
 If a socket doesn't have any reusable plugs defined at the item scope, there will be no entry for that socket. */
    public var plugs: [String: [DestinySocketsDestinyItemPlugBase]]?

    public init(plugs: [String: [DestinySocketsDestinyItemPlugBase]]? = nil) {
        self.plugs = plugs
    }
    ...
    public static func == (lhs: DestinyComponentsItemsDestinyItemReusablePlugsComponent, rhs: DestinyComponentsItemsDestinyItemReusablePlugsComponent) -> Bool {
