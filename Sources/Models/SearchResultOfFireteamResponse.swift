...
public struct SearchResultOfFireteamResponse: APIModel {
    ...
    public var results: [FireteamFireteamResponse]?
...
This is a long-held historical throwback to when we used to do paging with known total results. Those queries toasted our database, and we were left to hastily alter our endpoints and create backward- compatible shims, of which useTotalResults is one. */
    ...
    public init(hasMore: Bool? = nil, query: QueriesPagedQuery? = nil, replacementContinuationToken: String? = nil, results: [FireteamFireteamResponse]? = nil, totalResults: Int? = nil, useTotalResults: Bool? = nil) {
    ...
    public static func == (lhs: SearchResultOfFireteamResponse, rhs: SearchResultOfFireteamResponse) -> Bool {
