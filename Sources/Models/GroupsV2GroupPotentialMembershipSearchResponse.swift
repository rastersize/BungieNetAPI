...
public struct GroupsV2GroupPotentialMembershipSearchResponse: APIModel {
    ...
    public var results: [GroupsV2GroupPotentialMembership]?
...
This is a long-held historical throwback to when we used to do paging with known total results. Those queries toasted our database, and we were left to hastily alter our endpoints and create backward- compatible shims, of which useTotalResults is one. */
    ...
    public init(hasMore: Bool? = nil, query: QueriesPagedQuery? = nil, replacementContinuationToken: String? = nil, results: [GroupsV2GroupPotentialMembership]? = nil, totalResults: Int? = nil, useTotalResults: Bool? = nil) {
    ...
    public static func == (lhs: GroupsV2GroupPotentialMembershipSearchResponse, rhs: GroupsV2GroupPotentialMembershipSearchResponse) -> Bool {
