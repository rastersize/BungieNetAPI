...
public struct DestinyMilestonesDestinyPublicMilestoneActivityVariant: APIModel {
    ...
    public init(activityHash: Int? = nil, activityModeHash: Int? = nil, activityModeType: ActivityModeType? = nil) {
    ...
    public static func == (lhs: DestinyMilestonesDestinyPublicMilestoneActivityVariant, rhs: DestinyMilestonesDestinyPublicMilestoneActivityVariant) -> Bool {
