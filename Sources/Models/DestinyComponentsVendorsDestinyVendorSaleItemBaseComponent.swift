...
public struct DestinyComponentsVendorsDestinyVendorSaleItemBaseComponent: APIModel {
...
Most systems avoid this problem, but Vendors is one area where we are unable to reasonably avoid content dependency at the moment. */
    ...
    public static func == (lhs: DestinyComponentsVendorsDestinyVendorSaleItemBaseComponent, rhs: DestinyComponentsVendorsDestinyVendorSaleItemBaseComponent) -> Bool {
