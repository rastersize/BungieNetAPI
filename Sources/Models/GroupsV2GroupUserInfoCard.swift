...
public struct GroupsV2GroupUserInfoCard: APIModel {
    ...
    public var lastSeenDisplayNameType: Int?
 ...
 Not in Cross Save = its original membership type. Cross Save Primary = Any membership types it is overridding, and its original membership type Cross Save Overridden = Empty list */
    ...
    public init(lastSeenDisplayName: String? = nil, lastSeenDisplayNameType: Int? = nil, applicableMembershipTypes: [Int]? = nil, crossSaveOverride: Int? = nil, displayName: String? = nil, iconPath: String? = nil, isPublic: Bool? = nil, membershipId: Int? = nil, membershipType: Int? = nil, supplementalDisplayName: String? = nil) {
    ...
    public init(from decoder: Decoder) throws {
        ...
        lastSeenDisplayName = try container.decodeIfPresent("LastSeenDisplayName")
        lastSeenDisplayNameType = try container.decodeIfPresent("LastSeenDisplayNameType")
    ...
    public func encode(to encoder: Encoder) throws {
        ...
        try container.encodeIfPresent(lastSeenDisplayName, forKey: "LastSeenDisplayName")
        try container.encodeIfPresent(lastSeenDisplayNameType, forKey: "LastSeenDisplayNameType")
    ...
    public static func == (lhs: GroupsV2GroupUserInfoCard, rhs: GroupsV2GroupUserInfoCard) -> Bool {
        guard lhs.lastSeenDisplayName == rhs.lastSeenDisplayName else { return false }
        guard lhs.lastSeenDisplayNameType == rhs.lastSeenDisplayNameType else { return false }
