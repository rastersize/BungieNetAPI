...
public struct DestinyComponentsItemsDestinyItemPlugComponent: APIModel {
...
This list will be empty if the plug can be inserted. */
    ...
    public static func == (lhs: DestinyComponentsItemsDestinyItemPlugComponent, rhs: DestinyComponentsItemsDestinyItemPlugComponent) -> Bool {
