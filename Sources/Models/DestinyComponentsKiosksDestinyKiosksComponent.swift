...
public struct DestinyComponentsKiosksDestinyKiosksComponent: APIModel {
    ...
    public var kioskItems: [String: [DestinyComponentsKiosksDestinyKioskItem]]?

    public init(kioskItems: [String: [DestinyComponentsKiosksDestinyKioskItem]]? = nil) {
        self.kioskItems = kioskItems
    }

    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: StringCodingKey.self)

        kioskItems = try container.decodeIfPresent("kioskItems")
    }

    public func encode(to encoder: Encoder) throws {
        var container = encoder.container(keyedBy: StringCodingKey.self)

        try container.encodeIfPresent(kioskItems, forKey: "kioskItems")
    }

    public static func == (lhs: DestinyComponentsKiosksDestinyKiosksComponent, rhs: DestinyComponentsKiosksDestinyKiosksComponent) -> Bool {
        guard lhs.kioskItems == rhs.kioskItems else { return false }
        return true
    }
}
