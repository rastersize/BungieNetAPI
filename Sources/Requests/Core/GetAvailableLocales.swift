...
extension BungieNetAPI.Core {
    ...
    public enum GetAvailableLocales {

        public static let service = APIService<Response>(id: ".GetAvailableLocales", tag: "Core", method: "GET", path: "/GetAvailableLocales/", hasBody: false)

        public final class Request: APIRequest<Response> {

            public init() {
                super.init(service: GetAvailableLocales.service)
            }
        }
