...
extension BungieNetAPI.Core {
    ...
    public enum GetCommonSettings {

        public static let service = APIService<Response>(id: ".GetCommonSettings", tag: "Core", method: "GET", path: "/Settings/", hasBody: false)

        public final class Request: APIRequest<Response> {

            public init() {
                super.init(service: GetCommonSettings.service)
            }
        }
        ...
        public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
            ...
            public struct Status200: APIModel {
                ...
                public var response: CommonModelsCoreSettingsConfiguration?

                public var throttleSeconds: Int?

                public init(detailedErrorTrace: String? = nil, errorCode: Int? = nil, errorStatus: String? = nil, message: String? = nil, messageData: [String: String]? = nil, response: CommonModelsCoreSettingsConfiguration? = nil, throttleSeconds: Int? = nil) {
