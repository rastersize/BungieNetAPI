...
extension BungieNetAPI.CommunityContent {
    ...
    public enum CommunityContentGetCommunityLiveStatuses {

        public static let service = APIService<Response>(id: "CommunityContent.GetCommunityLiveStatuses", tag: "CommunityContent", method: "GET", path: "/CommunityContent/Live/All/{partnershipType}/{sort}/{page}/", hasBody: false)
        ...
        public final class Request: APIRequest<Response> {
            ...
            public struct Options {
                ...
                public init(modeHash: Int? = nil, page: Int, partnershipType: Int, sort: Int, streamLocale: String? = nil) {
                    self.modeHash = modeHash
                    self.page = page
            ...
            public init(options: Options) {
                ...
                super.init(service: CommunityContentGetCommunityLiveStatuses.service)
            }

            /// convenience initialiser so an Option doesn't have to be created
            public convenience init(modeHash: Int? = nil, page: Int, partnershipType: Int, sort: Int, streamLocale: String? = nil) {
                let options = Options(modeHash: modeHash, page: page, partnershipType: partnershipType, sort: sort, streamLocale: streamLocale)
            ...
            public override var queryParameters: [String: Any] {
                ...
                if let modeHash = options.modeHash {
