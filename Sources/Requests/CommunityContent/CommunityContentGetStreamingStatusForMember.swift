...
extension BungieNetAPI.CommunityContent {
    ...
    public enum CommunityContentGetStreamingStatusForMember {

        public static let service = APIService<Response>(id: "CommunityContent.GetStreamingStatusForMember", tag: "CommunityContent", method: "GET", path: "/CommunityContent/Live/Users/{partnershipType}/{membershipType}/{membershipId}/", hasBody: false)
        ...
        public final class Request: APIRequest<Response> {
            ...
            public struct Options {
                ...
                public init(membershipId: Int, membershipType: Int, partnershipType: Int) {
            ...
            public init(options: Options) {
                ...
                super.init(service: CommunityContentGetStreamingStatusForMember.service)
            }

            /// convenience initialiser so an Option doesn't have to be created
            public convenience init(membershipId: Int, membershipType: Int, partnershipType: Int) {
                let options = Options(membershipId: membershipId, membershipType: membershipType, partnershipType: partnershipType)
                self.init(options: options)
            }

            public override var path: String {
                return super.path.replacingOccurrences(of: "{" + "membershipId" + "}", with: "\(self.options.membershipId)").replacingOccurrences(of: "{" + "membershipType" + "}", with: "\(self.options.membershipType)").replacingOccurrences(of: "{" + "partnershipType" + "}", with: "\(self.options.partnershipType)")
            }
        }
        ...
        public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
            ...
            public struct Status200: APIModel {
                ...
                public var response: CommunityCommunityLiveStatus?

                public var throttleSeconds: Int?

                public init(detailedErrorTrace: String? = nil, errorCode: Int? = nil, errorStatus: String? = nil, message: String? = nil, messageData: [String: String]? = nil, response: CommunityCommunityLiveStatus? = nil, throttleSeconds: Int? = nil) {
