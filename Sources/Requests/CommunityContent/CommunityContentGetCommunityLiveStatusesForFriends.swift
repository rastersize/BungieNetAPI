...
extension BungieNetAPI.CommunityContent {
    ...
    public enum CommunityContentGetCommunityLiveStatusesForFriends {

        public static let service = APIService<Response>(id: "CommunityContent.GetCommunityLiveStatusesForFriends", tag: "CommunityContent", method: "GET", path: "/CommunityContent/Live/Friends/{partnershipType}/{sort}/{page}/", hasBody: false)
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: CommunityContentGetCommunityLiveStatusesForFriends.service)
            }
