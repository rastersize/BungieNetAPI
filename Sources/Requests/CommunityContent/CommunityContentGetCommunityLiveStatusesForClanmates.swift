...
extension BungieNetAPI.CommunityContent {
    ...
    public enum CommunityContentGetCommunityLiveStatusesForClanmates {

        public static let service = APIService<Response>(id: "CommunityContent.GetCommunityLiveStatusesForClanmates", tag: "CommunityContent", method: "GET", path: "/CommunityContent/Live/Clan/{partnershipType}/{sort}/{page}/", hasBody: false)
        ...
        public final class Request: APIRequest<Response> {
            ...
            public struct Options {
                ...
                public init(page: Int, partnershipType: Int, sort: Int) {
                    self.page = page
            ...
            public init(options: Options) {
                ...
                super.init(service: CommunityContentGetCommunityLiveStatusesForClanmates.service)
            }

            /// convenience initialiser so an Option doesn't have to be created
            public convenience init(page: Int, partnershipType: Int, sort: Int) {
                let options = Options(page: page, partnershipType: partnershipType, sort: sort)
