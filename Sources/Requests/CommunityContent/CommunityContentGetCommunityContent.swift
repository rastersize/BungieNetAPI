...
extension BungieNetAPI.CommunityContent {
    ...
    public enum CommunityContentGetCommunityContent {

        public static let service = APIService<Response>(id: "CommunityContent.GetCommunityContent", tag: "CommunityContent", method: "GET", path: "/CommunityContent/Get/{sort}/{mediaFilter}/{page}/", hasBody: false)
        ...
        public final class Request: APIRequest<Response> {
            ...
            public struct Options {
                ...
                public init(mediaFilter: Int, page: Int, sort: Int) {
            ...
            public init(options: Options) {
                ...
                super.init(service: CommunityContentGetCommunityContent.service)
            }

            /// convenience initialiser so an Option doesn't have to be created
            public convenience init(mediaFilter: Int, page: Int, sort: Int) {
                let options = Options(mediaFilter: mediaFilter, page: page, sort: sort)
                self.init(options: options)
            }

            public override var path: String {
                return super.path.replacingOccurrences(of: "{" + "mediaFilter" + "}", with: "\(self.options.mediaFilter)").replacingOccurrences(of: "{" + "page" + "}", with: "\(self.options.page)").replacingOccurrences(of: "{" + "sort" + "}", with: "\(self.options.sort)")
            }
        }
