...
extension BungieNetAPI.Fireteam {
    ...
    public enum FireteamGetActivePrivateClanFireteamCount {

        public static let service = APIService<Response>(id: "Fireteam.GetActivePrivateClanFireteamCount", tag: "Fireteam", method: "GET", path: "/Fireteam/Clan/{groupId}/ActiveCount/", hasBody: false, securityRequirement: SecurityRequirement(type: "oauth2", scopes: ["ReadGroups"]))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: FireteamGetActivePrivateClanFireteamCount.service)
            }
