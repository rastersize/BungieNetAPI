...
extension BungieNetAPI.Fireteam {
    ...
    public enum FireteamSearchPublicAvailableClanFireteams {

        public static let service = APIService<Response>(id: "Fireteam.SearchPublicAvailableClanFireteams", tag: "Fireteam", method: "GET", path: "/Fireteam/Search/Available/{platform}/{activityType}/{dateRange}/{slotFilter}/{page}/", hasBody: false, securityRequirement: SecurityRequirement(type: "oauth2", scopes: ["ReadGroups"]))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public struct Options {
                ...
                public init(activityType: Int, dateRange: Int, langFilter: String? = nil, page: Int, platform: Int, slotFilter: Int) {
            ...
            public init(options: Options) {
                ...
                super.init(service: FireteamSearchPublicAvailableClanFireteams.service)
            }

            /// convenience initialiser so an Option doesn't have to be created
            public convenience init(activityType: Int, dateRange: Int, langFilter: String? = nil, page: Int, platform: Int, slotFilter: Int) {
                let options = Options(activityType: activityType, dateRange: dateRange, langFilter: langFilter, page: page, platform: platform, slotFilter: slotFilter)
                self.init(options: options)
            }

            public override var path: String {
                return super.path.replacingOccurrences(of: "{" + "activityType" + "}", with: "\(self.options.activityType)").replacingOccurrences(of: "{" + "dateRange" + "}", with: "\(self.options.dateRange)").replacingOccurrences(of: "{" + "page" + "}", with: "\(self.options.page)").replacingOccurrences(of: "{" + "platform" + "}", with: "\(self.options.platform)").replacingOccurrences(of: "{" + "slotFilter" + "}", with: "\(self.options.slotFilter)")
            }
