...
extension BungieNetAPI.Fireteam {
    ...
    public enum FireteamGetClanFireteam {

        public static let service = APIService<Response>(id: "Fireteam.GetClanFireteam", tag: "Fireteam", method: "GET", path: "/Fireteam/Clan/{groupId}/Summary/{fireteamId}/", hasBody: false, securityRequirement: SecurityRequirement(type: "oauth2", scopes: ["ReadGroups"]))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public struct Options {
                ...
                public init(fireteamId: Int, groupId: Int) {
            ...
            public init(options: Options) {
                ...
                super.init(service: FireteamGetClanFireteam.service)
            }

            /// convenience initialiser so an Option doesn't have to be created
            public convenience init(fireteamId: Int, groupId: Int) {
                let options = Options(fireteamId: fireteamId, groupId: groupId)
                self.init(options: options)
            }

            public override var path: String {
                return super.path.replacingOccurrences(of: "{" + "fireteamId" + "}", with: "\(self.options.fireteamId)").replacingOccurrences(of: "{" + "groupId" + "}", with: "\(self.options.groupId)")
            }
        }
        ...
        public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
            ...
            public struct Status200: APIModel {
                ...
                public var response: FireteamFireteamResponse?

                public var throttleSeconds: Int?

                public init(detailedErrorTrace: String? = nil, errorCode: Int? = nil, errorStatus: String? = nil, message: String? = nil, messageData: [String: String]? = nil, response: FireteamFireteamResponse? = nil, throttleSeconds: Int? = nil) {
