...
extension BungieNetAPI.App {
    ...
    public enum AppGetBungieApplications {

        public static let service = APIService<Response>(id: "App.GetBungieApplications", tag: "App", method: "GET", path: "/App/FirstParty/", hasBody: false)

        public final class Request: APIRequest<Response> {

            public init() {
                super.init(service: AppGetBungieApplications.service)
            }
        }
        ...
        public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
            ...
            public struct Status200: APIModel {
                ...
                public var response: [ApplicationsApplication]?

                public var throttleSeconds: Int?

                public init(detailedErrorTrace: String? = nil, errorCode: Int? = nil, errorStatus: String? = nil, message: String? = nil, messageData: [String: String]? = nil, response: [ApplicationsApplication]? = nil, throttleSeconds: Int? = nil) {
