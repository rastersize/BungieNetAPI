...
extension BungieNetAPI.GroupV2 {
    ...
    public enum GroupV2GetGroupByName {

        public static let service = APIService<Response>(id: "GroupV2.GetGroupByName", tag: "GroupV2", method: "GET", path: "/GroupV2/Name/{groupName}/{groupType}/", hasBody: false)
        ...
        public final class Request: APIRequest<Response> {
            ...
            public struct Options {
                ...
                public init(groupName: String, groupType: Int) {
            ...
            public init(options: Options) {
                ...
                super.init(service: GroupV2GetGroupByName.service)
            }

            /// convenience initialiser so an Option doesn't have to be created
            public convenience init(groupName: String, groupType: Int) {
                let options = Options(groupName: groupName, groupType: groupType)
                self.init(options: options)
            }

            public override var path: String {
                return super.path.replacingOccurrences(of: "{" + "groupName" + "}", with: "\(self.options.groupName)").replacingOccurrences(of: "{" + "groupType" + "}", with: "\(self.options.groupType)")
            }
        }
        ...
        public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
            ...
            public struct Status200: APIModel {
                ...
                public var response: GroupsV2GroupResponse?

                public var throttleSeconds: Int?

                public init(detailedErrorTrace: String? = nil, errorCode: Int? = nil, errorStatus: String? = nil, message: String? = nil, messageData: [String: String]? = nil, response: GroupsV2GroupResponse? = nil, throttleSeconds: Int? = nil) {
