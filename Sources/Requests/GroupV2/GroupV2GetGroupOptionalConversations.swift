...
extension BungieNetAPI.GroupV2 {
    ...
    public enum GroupV2GetGroupOptionalConversations {

        public static let service = APIService<Response>(id: "GroupV2.GetGroupOptionalConversations", tag: "GroupV2", method: "GET", path: "/GroupV2/{groupId}/OptionalConversations/", hasBody: false)
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: GroupV2GetGroupOptionalConversations.service)
            }
        ...
        public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
            ...
            public struct Status200: APIModel {
                ...
                public var response: [GroupsV2GroupOptionalConversation]?

                public var throttleSeconds: Int?

                public init(detailedErrorTrace: String? = nil, errorCode: Int? = nil, errorStatus: String? = nil, message: String? = nil, messageData: [String: String]? = nil, response: [GroupsV2GroupOptionalConversation]? = nil, throttleSeconds: Int? = nil) {
