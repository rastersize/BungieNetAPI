...
extension BungieNetAPI.GroupV2 {
    ...
    public enum GroupV2DenyAllPending {

        public static let service = APIService<Response>(id: "GroupV2.DenyAllPending", tag: "GroupV2", method: "POST", path: "/GroupV2/{groupId}/Members/DenyAll/", hasBody: true, securityRequirement: SecurityRequirement(type: "oauth2", scopes: ["AdminGroups"]))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(body: GroupsV2GroupApplicationRequest, options: Options, encoder: RequestEncoder? = nil) {
                ...
                super.init(service: GroupV2DenyAllPending.service) { defaultEncoder in
