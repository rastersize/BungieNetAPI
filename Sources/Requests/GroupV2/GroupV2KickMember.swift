...
extension BungieNetAPI.GroupV2 {
    ...
    public enum GroupV2KickMember {

        public static let service = APIService<Response>(id: "GroupV2.KickMember", tag: "GroupV2", method: "POST", path: "/GroupV2/{groupId}/Members/{membershipType}/{membershipId}/Kick/", hasBody: false, securityRequirement: SecurityRequirement(type: "oauth2", scopes: ["AdminGroups"]))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: GroupV2KickMember.service)
            }
        ...
        public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
            ...
            public struct Status200: APIModel {
                ...
                public var response: GroupsV2GroupMemberLeaveResult?

                public var throttleSeconds: Int?

                public init(detailedErrorTrace: String? = nil, errorCode: Int? = nil, errorStatus: String? = nil, message: String? = nil, messageData: [String: String]? = nil, response: GroupsV2GroupMemberLeaveResult? = nil, throttleSeconds: Int? = nil) {
