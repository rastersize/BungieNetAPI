...
extension BungieNetAPI.GroupV2 {
    ...
    public enum GroupV2GetUserClanInviteSetting {

        public static let service = APIService<Response>(id: "GroupV2.GetUserClanInviteSetting", tag: "GroupV2", method: "GET", path: "/GroupV2/GetUserClanInviteSetting/{mType}/", hasBody: false, securityRequirement: SecurityRequirement(type: "oauth2", scopes: ["ReadUserData"]))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: GroupV2GetUserClanInviteSetting.service)
            }

            /// convenience initialiser so an Option doesn't have to be created
            public convenience init(mType: Int) {
                let options = Options(mType: mType)
                self.init(options: options)
            }

            public override var path: String {
                return super.path.replacingOccurrences(of: "{" + "mType" + "}", with: "\(self.options.mType)")
            }
        }
