...
extension BungieNetAPI.GroupV2 {
    ...
    public enum GroupV2GetGroupByNameV2 {

        public static let service = APIService<Response>(id: "GroupV2.GetGroupByNameV2", tag: "GroupV2", method: "POST", path: "/GroupV2/NameV2/", hasBody: true)

        public final class Request: APIRequest<Response> {

            public var body: GroupsV2GroupNameSearchRequest

            public init(body: GroupsV2GroupNameSearchRequest, encoder: RequestEncoder? = nil) {
                self.body = body
                super.init(service: GroupV2GetGroupByNameV2.service) { defaultEncoder in
