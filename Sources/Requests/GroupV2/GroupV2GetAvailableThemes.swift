...
extension BungieNetAPI.GroupV2 {
    ...
    public enum GroupV2GetAvailableThemes {

        public static let service = APIService<Response>(id: "GroupV2.GetAvailableThemes", tag: "GroupV2", method: "GET", path: "/GroupV2/GetAvailableThemes/", hasBody: false)

        public final class Request: APIRequest<Response> {

            public init() {
                super.init(service: GroupV2GetAvailableThemes.service)
            }
        }
        ...
        public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
            ...
            public struct Status200: APIModel {
                ...
                public var response: [ConfigGroupTheme]?

                public var throttleSeconds: Int?

                public init(detailedErrorTrace: String? = nil, errorCode: Int? = nil, errorStatus: String? = nil, message: String? = nil, messageData: [String: String]? = nil, response: [ConfigGroupTheme]? = nil, throttleSeconds: Int? = nil) {
