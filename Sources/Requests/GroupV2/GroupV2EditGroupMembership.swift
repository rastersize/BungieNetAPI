...
extension BungieNetAPI.GroupV2 {
    ...
    public enum GroupV2EditGroupMembership {

        public static let service = APIService<Response>(id: "GroupV2.EditGroupMembership", tag: "GroupV2", method: "POST", path: "/GroupV2/{groupId}/Members/{membershipType}/{membershipId}/SetMembershipType/{memberType}/", hasBody: false, securityRequirement: SecurityRequirement(type: "oauth2", scopes: ["AdminGroups"]))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public struct Options {
                ...
                public init(groupId: Int, membershipId: Int, membershipType: Int, memberType: Int) {
            ...
            public init(options: Options) {
                ...
                super.init(service: GroupV2EditGroupMembership.service)
            }

            /// convenience initialiser so an Option doesn't have to be created
            public convenience init(groupId: Int, membershipId: Int, membershipType: Int, memberType: Int) {
                let options = Options(groupId: groupId, membershipId: membershipId, membershipType: membershipType, memberType: memberType)
                self.init(options: options)
            }

            public override var path: String {
                return super.path.replacingOccurrences(of: "{" + "groupId" + "}", with: "\(self.options.groupId)").replacingOccurrences(of: "{" + "membershipId" + "}", with: "\(self.options.membershipId)").replacingOccurrences(of: "{" + "membershipType" + "}", with: "\(self.options.membershipType)").replacingOccurrences(of: "{" + "memberType" + "}", with: "\(self.options.memberType)")
            }
        }
