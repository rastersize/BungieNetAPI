...
extension BungieNetAPI.GroupV2 {
    ...
    /** Search for Groups. */
    public enum GroupV2GroupSearch {

        public static let service = APIService<Response>(id: "GroupV2.GroupSearch", tag: "GroupV2", method: "POST", path: "/GroupV2/Search/", hasBody: true)

        public final class Request: APIRequest<Response> {

            public var body: GroupsV2GroupQuery

            public init(body: GroupsV2GroupQuery, encoder: RequestEncoder? = nil) {
                self.body = body
                super.init(service: GroupV2GroupSearch.service) { defaultEncoder in
        ...
        public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
            ...
            public struct Status200: APIModel {
                ...
                public var response: GroupsV2GroupSearchResponse?

                public var throttleSeconds: Int?

                public init(detailedErrorTrace: String? = nil, errorCode: Int? = nil, errorStatus: String? = nil, message: String? = nil, messageData: [String: String]? = nil, response: GroupsV2GroupSearchResponse? = nil, throttleSeconds: Int? = nil) {
