...
extension BungieNetAPI.GroupV2 {
    ...
    public enum GroupV2GetAdminsAndFounderOfGroup {

        public static let service = APIService<Response>(id: "GroupV2.GetAdminsAndFounderOfGroup", tag: "GroupV2", method: "GET", path: "/GroupV2/{groupId}/AdminsAndFounder/", hasBody: false)
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: GroupV2GetAdminsAndFounderOfGroup.service)
            }
