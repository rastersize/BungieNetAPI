...
extension BungieNetAPI.GroupV2 {
    ...
    public enum GroupV2BanMember {

        public static let service = APIService<Response>(id: "GroupV2.BanMember", tag: "GroupV2", method: "POST", path: "/GroupV2/{groupId}/Members/{membershipType}/{membershipId}/Ban/", hasBody: true, securityRequirement: SecurityRequirement(type: "oauth2", scopes: ["AdminGroups"]))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public var body: GroupsV2GroupBanRequest

            public init(body: GroupsV2GroupBanRequest, options: Options, encoder: RequestEncoder? = nil) {
                self.body = body
                self.options = options
                super.init(service: GroupV2BanMember.service) { defaultEncoder in
                    return try (encoder ?? defaultEncoder).encode(body)
                }
            }

            /// convenience initialiser so an Option doesn't have to be created
            public convenience init(groupId: Int, membershipId: Int, membershipType: Int, body: GroupsV2GroupBanRequest) {
