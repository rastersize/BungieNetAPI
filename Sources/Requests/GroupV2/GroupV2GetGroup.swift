...
extension BungieNetAPI.GroupV2 {
    ...
    public enum GroupV2GetGroup {

        public static let service = APIService<Response>(id: "GroupV2.GetGroup", tag: "GroupV2", method: "GET", path: "/GroupV2/{groupId}/", hasBody: false)
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: GroupV2GetGroup.service)
            }
