...
extension BungieNetAPI.GroupV2 {
    ...
    public enum GroupV2ApproveAllPending {

        public static let service = APIService<Response>(id: "GroupV2.ApproveAllPending", tag: "GroupV2", method: "POST", path: "/GroupV2/{groupId}/Members/ApproveAll/", hasBody: true, securityRequirement: SecurityRequirement(type: "oauth2", scopes: ["AdminGroups"]))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(body: GroupsV2GroupApplicationRequest, options: Options, encoder: RequestEncoder? = nil) {
                ...
                super.init(service: GroupV2ApproveAllPending.service) { defaultEncoder in
                    return try (encoder ?? defaultEncoder).encode(body)
                }
            }

            /// convenience initialiser so an Option doesn't have to be created
            public convenience init(groupId: Int, body: GroupsV2GroupApplicationRequest) {
