...
extension BungieNetAPI.GroupV2 {
    ...
    public enum GroupV2GetBannedMembersOfGroup {

        public static let service = APIService<Response>(id: "GroupV2.GetBannedMembersOfGroup", tag: "GroupV2", method: "GET", path: "/GroupV2/{groupId}/Banned/", hasBody: false, securityRequirement: SecurityRequirement(type: "oauth2", scopes: ["AdminGroups"]))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: GroupV2GetBannedMembersOfGroup.service)
            }
        ...
        public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
            ...
            public struct Status200: APIModel {
                ...
                public var response: SearchResultOfGroupBan?

                public var throttleSeconds: Int?

                public init(detailedErrorTrace: String? = nil, errorCode: Int? = nil, errorStatus: String? = nil, message: String? = nil, messageData: [String: String]? = nil, response: SearchResultOfGroupBan? = nil, throttleSeconds: Int? = nil) {
