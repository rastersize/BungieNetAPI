...
extension BungieNetAPI.GroupV2 {
    ...
    public enum GroupV2GetPendingMemberships {

        public static let service = APIService<Response>(id: "GroupV2.GetPendingMemberships", tag: "GroupV2", method: "GET", path: "/GroupV2/{groupId}/Members/Pending/", hasBody: false, securityRequirement: SecurityRequirement(type: "oauth2", scopes: ["AdminGroups"]))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: GroupV2GetPendingMemberships.service)
            }
