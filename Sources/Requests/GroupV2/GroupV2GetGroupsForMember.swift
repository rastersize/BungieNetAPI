...
extension BungieNetAPI.GroupV2 {
    ...
    public enum GroupV2GetGroupsForMember {

        public static let service = APIService<Response>(id: "GroupV2.GetGroupsForMember", tag: "GroupV2", method: "GET", path: "/GroupV2/User/{membershipType}/{membershipId}/{filter}/{groupType}/", hasBody: false)
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: GroupV2GetGroupsForMember.service)
            }
        ...
        public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
            ...
            public struct Status200: APIModel {
                ...
                public var response: GroupsV2GetGroupsForMemberResponse?

                public var throttleSeconds: Int?

                public init(detailedErrorTrace: String? = nil, errorCode: Int? = nil, errorStatus: String? = nil, message: String? = nil, messageData: [String: String]? = nil, response: GroupsV2GetGroupsForMemberResponse? = nil, throttleSeconds: Int? = nil) {
