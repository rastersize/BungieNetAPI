...
extension BungieNetAPI.GroupV2 {
    ...
    public enum GroupV2EditOptionalConversation {

        public static let service = APIService<Response>(id: "GroupV2.EditOptionalConversation", tag: "GroupV2", method: "POST", path: "/GroupV2/{groupId}/OptionalConversations/Edit/{conversationId}/", hasBody: true, securityRequirement: SecurityRequirement(type: "oauth2", scopes: ["AdminGroups"]))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public struct Options {
                ...
                public init(conversationId: Int, groupId: Int) {
            ...
            public var body: GroupsV2GroupOptionalConversationEditRequest

            public init(body: GroupsV2GroupOptionalConversationEditRequest, options: Options, encoder: RequestEncoder? = nil) {
                self.body = body
                self.options = options
                super.init(service: GroupV2EditOptionalConversation.service) { defaultEncoder in
                    return try (encoder ?? defaultEncoder).encode(body)
                }
            }

            /// convenience initialiser so an Option doesn't have to be created
            public convenience init(conversationId: Int, groupId: Int, body: GroupsV2GroupOptionalConversationEditRequest) {
                let options = Options(conversationId: conversationId, groupId: groupId)
                self.init(body: body, options: options)
            }

            public override var path: String {
                return super.path.replacingOccurrences(of: "{" + "conversationId" + "}", with: "\(self.options.conversationId)").replacingOccurrences(of: "{" + "groupId" + "}", with: "\(self.options.groupId)")
            }
        }
