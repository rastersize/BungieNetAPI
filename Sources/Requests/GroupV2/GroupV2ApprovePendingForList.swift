...
extension BungieNetAPI.GroupV2 {
    ...
    public enum GroupV2ApprovePendingForList {

        public static let service = APIService<Response>(id: "GroupV2.ApprovePendingForList", tag: "GroupV2", method: "POST", path: "/GroupV2/{groupId}/Members/ApproveList/", hasBody: true, securityRequirement: SecurityRequirement(type: "oauth2", scopes: ["AdminGroups"]))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public var body: GroupsV2GroupApplicationListRequest

            public init(body: GroupsV2GroupApplicationListRequest, options: Options, encoder: RequestEncoder? = nil) {
                self.body = body
                self.options = options
                super.init(service: GroupV2ApprovePendingForList.service) { defaultEncoder in
                    return try (encoder ?? defaultEncoder).encode(body)
                }
            }

            /// convenience initialiser so an Option doesn't have to be created
            public convenience init(groupId: Int, body: GroupsV2GroupApplicationListRequest) {
        ...
        public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
            ...
            public struct Status200: APIModel {
                ...
                public var response: [EntitiesEntityActionResult]?

                public var throttleSeconds: Int?

                public init(detailedErrorTrace: String? = nil, errorCode: Int? = nil, errorStatus: String? = nil, message: String? = nil, messageData: [String: String]? = nil, response: [EntitiesEntityActionResult]? = nil, throttleSeconds: Int? = nil) {
