...
extension BungieNetAPI.GroupV2 {
    ...
    public enum GroupV2GetInvitedIndividuals {

        public static let service = APIService<Response>(id: "GroupV2.GetInvitedIndividuals", tag: "GroupV2", method: "GET", path: "/GroupV2/{groupId}/Members/InvitedIndividuals/", hasBody: false, securityRequirement: SecurityRequirement(type: "oauth2", scopes: ["AdminGroups"]))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public struct Options {
                ...
                public init(currentpage: Int, groupId: Int) {
            ...
            public init(options: Options) {
                ...
                super.init(service: GroupV2GetInvitedIndividuals.service)
            }

            /// convenience initialiser so an Option doesn't have to be created
            public convenience init(currentpage: Int, groupId: Int) {
                let options = Options(currentpage: currentpage, groupId: groupId)
        ...
        public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
            ...
            public struct Status200: APIModel {
                ...
                public var response: SearchResultOfGroupMemberApplication?

                public var throttleSeconds: Int?

                public init(detailedErrorTrace: String? = nil, errorCode: Int? = nil, errorStatus: String? = nil, message: String? = nil, messageData: [String: String]? = nil, response: SearchResultOfGroupMemberApplication? = nil, throttleSeconds: Int? = nil) {
