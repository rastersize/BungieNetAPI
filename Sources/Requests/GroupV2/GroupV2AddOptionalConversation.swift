...
extension BungieNetAPI.GroupV2 {
    ...
    public enum GroupV2AddOptionalConversation {

        public static let service = APIService<Response>(id: "GroupV2.AddOptionalConversation", tag: "GroupV2", method: "POST", path: "/GroupV2/{groupId}/OptionalConversations/Add/", hasBody: true, securityRequirement: SecurityRequirement(type: "oauth2", scopes: ["AdminGroups"]))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public var body: GroupsV2GroupOptionalConversationAddRequest

            public init(body: GroupsV2GroupOptionalConversationAddRequest, options: Options, encoder: RequestEncoder? = nil) {
                self.body = body
                self.options = options
                super.init(service: GroupV2AddOptionalConversation.service) { defaultEncoder in
                    return try (encoder ?? defaultEncoder).encode(body)
                }
            }

            /// convenience initialiser so an Option doesn't have to be created
            public convenience init(groupId: Int, body: GroupsV2GroupOptionalConversationAddRequest) {
