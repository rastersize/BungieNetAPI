...
extension BungieNetAPI.GroupV2 {
    ...
    public enum GroupV2UnbanMember {

        public static let service = APIService<Response>(id: "GroupV2.UnbanMember", tag: "GroupV2", method: "POST", path: "/GroupV2/{groupId}/Members/{membershipType}/{membershipId}/Unban/", hasBody: false, securityRequirement: SecurityRequirement(type: "oauth2", scopes: ["AdminGroups"]))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: GroupV2UnbanMember.service)
            }
