...
extension BungieNetAPI.GroupV2 {
    ...
    public enum GroupV2IndividualGroupInvite {

        public static let service = APIService<Response>(id: "GroupV2.IndividualGroupInvite", tag: "GroupV2", method: "POST", path: "/GroupV2/{groupId}/Members/IndividualInvite/{membershipType}/{membershipId}/", hasBody: true, securityRequirement: SecurityRequirement(type: "oauth2", scopes: ["AdminGroups"]))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(body: GroupsV2GroupApplicationRequest, options: Options, encoder: RequestEncoder? = nil) {
                ...
                super.init(service: GroupV2IndividualGroupInvite.service) { defaultEncoder in
        ...
        public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
            ...
            public struct Status200: APIModel {
                ...
                public var response: GroupsV2GroupApplicationResponse?

                public var throttleSeconds: Int?

                public init(detailedErrorTrace: String? = nil, errorCode: Int? = nil, errorStatus: String? = nil, message: String? = nil, messageData: [String: String]? = nil, response: GroupsV2GroupApplicationResponse? = nil, throttleSeconds: Int? = nil) {
