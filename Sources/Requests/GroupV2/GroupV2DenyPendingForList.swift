...
extension BungieNetAPI.GroupV2 {
    ...
    public enum GroupV2DenyPendingForList {

        public static let service = APIService<Response>(id: "GroupV2.DenyPendingForList", tag: "GroupV2", method: "POST", path: "/GroupV2/{groupId}/Members/DenyList/", hasBody: true, securityRequirement: SecurityRequirement(type: "oauth2", scopes: ["AdminGroups"]))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(body: GroupsV2GroupApplicationListRequest, options: Options, encoder: RequestEncoder? = nil) {
                ...
                super.init(service: GroupV2DenyPendingForList.service) { defaultEncoder in
