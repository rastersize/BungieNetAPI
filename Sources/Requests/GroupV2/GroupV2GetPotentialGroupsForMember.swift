...
extension BungieNetAPI.GroupV2 {
    ...
    public enum GroupV2GetPotentialGroupsForMember {

        public static let service = APIService<Response>(id: "GroupV2.GetPotentialGroupsForMember", tag: "GroupV2", method: "GET", path: "/GroupV2/User/Potential/{membershipType}/{membershipId}/{filter}/{groupType}/", hasBody: false)
        ...
        public final class Request: APIRequest<Response> {
            ...
            public struct Options {
                ...
                public init(filter: Int, groupType: Int, membershipId: Int, membershipType: Int) {
                    self.filter = filter
            ...
            public init(options: Options) {
                ...
                super.init(service: GroupV2GetPotentialGroupsForMember.service)
            }

            /// convenience initialiser so an Option doesn't have to be created
            public convenience init(filter: Int, groupType: Int, membershipId: Int, membershipType: Int) {
                let options = Options(filter: filter, groupType: groupType, membershipId: membershipId, membershipType: membershipType)
                self.init(options: options)
            }

            public override var path: String {
                return super.path.replacingOccurrences(of: "{" + "filter" + "}", with: "\(self.options.filter)").replacingOccurrences(of: "{" + "groupType" + "}", with: "\(self.options.groupType)").replacingOccurrences(of: "{" + "membershipId" + "}", with: "\(self.options.membershipId)").replacingOccurrences(of: "{" + "membershipType" + "}", with: "\(self.options.membershipType)")
            }
        }
        ...
        public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
            ...
            public struct Status200: APIModel {
                ...
                public var response: GroupsV2GroupPotentialMembershipSearchResponse?

                public var throttleSeconds: Int?

                public init(detailedErrorTrace: String? = nil, errorCode: Int? = nil, errorStatus: String? = nil, message: String? = nil, messageData: [String: String]? = nil, response: GroupsV2GroupPotentialMembershipSearchResponse? = nil, throttleSeconds: Int? = nil) {
