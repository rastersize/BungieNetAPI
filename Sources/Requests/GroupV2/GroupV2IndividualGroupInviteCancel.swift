...
extension BungieNetAPI.GroupV2 {
    ...
    public enum GroupV2IndividualGroupInviteCancel {

        public static let service = APIService<Response>(id: "GroupV2.IndividualGroupInviteCancel", tag: "GroupV2", method: "POST", path: "/GroupV2/{groupId}/Members/IndividualInviteCancel/{membershipType}/{membershipId}/", hasBody: false, securityRequirement: SecurityRequirement(type: "oauth2", scopes: ["AdminGroups"]))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: GroupV2IndividualGroupInviteCancel.service)
            }

            /// convenience initialiser so an Option doesn't have to be created
            public convenience init(groupId: Int, membershipId: Int, membershipType: Int) {
