...
extension BungieNetAPI.User {
    ...
    public enum UserGetBungieNetUserById {

        public static let service = APIService<Response>(id: "User.GetBungieNetUserById", tag: "User", method: "GET", path: "/User/GetBungieNetUserById/{id}/", hasBody: false)
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: UserGetBungieNetUserById.service)
            }
