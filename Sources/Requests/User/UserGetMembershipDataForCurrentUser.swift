...
extension BungieNetAPI.User {
    ...
    public enum UserGetMembershipDataForCurrentUser {

        public static let service = APIService<Response>(id: "User.GetMembershipDataForCurrentUser", tag: "User", method: "GET", path: "/User/GetMembershipsForCurrentUser/", hasBody: false, securityRequirement: SecurityRequirement(type: "oauth2", scopes: ["ReadBasicUserProfile"]))

        public final class Request: APIRequest<Response> {

            public init() {
                super.init(service: UserGetMembershipDataForCurrentUser.service)
            }
        }
