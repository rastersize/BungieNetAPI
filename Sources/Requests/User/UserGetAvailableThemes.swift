...
extension BungieNetAPI.User {
    ...
    public enum UserGetAvailableThemes {

        public static let service = APIService<Response>(id: "User.GetAvailableThemes", tag: "User", method: "GET", path: "/User/GetAvailableThemes/", hasBody: false)

        public final class Request: APIRequest<Response> {

            public init() {
                super.init(service: UserGetAvailableThemes.service)
            }
        }
        ...
        public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
            ...
            public struct Status200: APIModel {
                ...
                public var response: [ConfigUserTheme]?

                public var throttleSeconds: Int?

                public init(detailedErrorTrace: String? = nil, errorCode: Int? = nil, errorStatus: String? = nil, message: String? = nil, messageData: [String: String]? = nil, response: [ConfigUserTheme]? = nil, throttleSeconds: Int? = nil) {
