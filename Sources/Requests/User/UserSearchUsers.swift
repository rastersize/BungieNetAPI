...
extension BungieNetAPI.User {
    ...
    public enum UserSearchUsers {

        public static let service = APIService<Response>(id: "User.SearchUsers", tag: "User", method: "GET", path: "/User/SearchUsers/", hasBody: false)
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: UserSearchUsers.service)
            }

            /// convenience initialiser so an Option doesn't have to be created
            public convenience init(q: String? = nil) {
                let options = Options(q: q)
        ...
        public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
            ...
            public struct Status200: APIModel {
                ...
                public var response: [UserGeneralUser]?

                public var throttleSeconds: Int?

                public init(detailedErrorTrace: String? = nil, errorCode: Int? = nil, errorStatus: String? = nil, message: String? = nil, messageData: [String: String]? = nil, response: [UserGeneralUser]? = nil, throttleSeconds: Int? = nil) {
