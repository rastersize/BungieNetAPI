...
extension BungieNetAPI.User {

    /** Gets any hard linked membership given a credential. Only works for credentials that are public (just SteamID64 right now). Cross Save aware. */
    public enum UserGetMembershipFromHardLinkedCredential {

        public static let service = APIService<Response>(id: "User.GetMembershipFromHardLinkedCredential", tag: "User", method: "GET", path: "/User/GetMembershipFromHardLinkedCredential/{crType}/{credential}/", hasBody: false)
        ...
        public final class Request: APIRequest<Response> {
            ...
            public struct Options {
                ...
                public var crType: Int

                public init(credential: String, crType: Int) {
            ...
            public init(options: Options) {
                ...
                super.init(service: UserGetMembershipFromHardLinkedCredential.service)
            }

            /// convenience initialiser so an Option doesn't have to be created
            public convenience init(credential: String, crType: Int) {
                let options = Options(credential: credential, crType: crType)
                self.init(options: options)
            }

            public override var path: String {
                return super.path.replacingOccurrences(of: "{" + "credential" + "}", with: "\(self.options.credential)").replacingOccurrences(of: "{" + "crType" + "}", with: "\(self.options.crType)")
            }
        }
        ...
        public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
            ...
            public struct Status200: APIModel {
                ...
                public var response: UserHardLinkedUserMembership?

                public var throttleSeconds: Int?

                public init(detailedErrorTrace: String? = nil, errorCode: Int? = nil, errorStatus: String? = nil, message: String? = nil, messageData: [String: String]? = nil, response: UserHardLinkedUserMembership? = nil, throttleSeconds: Int? = nil) {
