...
extension BungieNetAPI.User {
    ...
    public enum UserGetPartnerships {

        public static let service = APIService<Response>(id: "User.GetPartnerships", tag: "User", method: "GET", path: "/User/{membershipId}/Partnerships/", hasBody: false)
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: UserGetPartnerships.service)
            }

            /// convenience initialiser so an Option doesn't have to be created
            public convenience init(membershipId: Int) {
                let options = Options(membershipId: membershipId)
                self.init(options: options)
            }

            public override var path: String {
                return super.path.replacingOccurrences(of: "{" + "membershipId" + "}", with: "\(self.options.membershipId)")
            }
        }
        ...
        public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
            ...
            public struct Status200: APIModel {
                ...
                public var response: [PartnershipsPublicPartnershipDetail]?

                public var throttleSeconds: Int?

                public init(detailedErrorTrace: String? = nil, errorCode: Int? = nil, errorStatus: String? = nil, message: String? = nil, messageData: [String: String]? = nil, response: [PartnershipsPublicPartnershipDetail]? = nil, throttleSeconds: Int? = nil) {
