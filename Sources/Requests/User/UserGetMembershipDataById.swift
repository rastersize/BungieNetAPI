...
extension BungieNetAPI.User {
    ...
    public enum UserGetMembershipDataById {

        public static let service = APIService<Response>(id: "User.GetMembershipDataById", tag: "User", method: "GET", path: "/User/GetMembershipsById/{membershipId}/{membershipType}/", hasBody: false)
        ...
        public final class Request: APIRequest<Response> {
            ...
            public struct Options {
                ...
                public init(membershipId: Int, membershipType: Int) {
            ...
            public init(options: Options) {
                ...
                super.init(service: UserGetMembershipDataById.service)
            }

            /// convenience initialiser so an Option doesn't have to be created
            public convenience init(membershipId: Int, membershipType: Int) {
                let options = Options(membershipId: membershipId, membershipType: membershipType)
        ...
        public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
            ...
            public struct Status200: APIModel {
                ...
                public var response: UserUserMembershipData?

                public var throttleSeconds: Int?

                public init(detailedErrorTrace: String? = nil, errorCode: Int? = nil, errorStatus: String? = nil, message: String? = nil, messageData: [String: String]? = nil, response: UserUserMembershipData? = nil, throttleSeconds: Int? = nil) {
