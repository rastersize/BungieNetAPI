...
extension BungieNetAPI.Destiny2 {
    ...
    public enum Destiny2GetVendor {

        public static let service = APIService<Response>(id: "Destiny2.GetVendor", tag: "Destiny2", method: "GET", path: "/Destiny2/{membershipType}/Profile/{destinyMembershipId}/Character/{characterId}/Vendors/{vendorHash}/", hasBody: false)
        ...
        public final class Request: APIRequest<Response> {
            ...
            public struct Options {
                ...
                public init(characterId: Int, components: [Int]? = nil, destinyMembershipId: Int, membershipType: Int, vendorHash: Int) {
            ...
            public init(options: Options) {
                ...
                super.init(service: Destiny2GetVendor.service)
            }

            /// convenience initialiser so an Option doesn't have to be created
            public convenience init(characterId: Int, components: [Int]? = nil, destinyMembershipId: Int, membershipType: Int, vendorHash: Int) {
                let options = Options(characterId: characterId, components: components, destinyMembershipId: destinyMembershipId, membershipType: membershipType, vendorHash: vendorHash)
                self.init(options: options)
            }

            public override var path: String {
                return super.path.replacingOccurrences(of: "{" + "characterId" + "}", with: "\(self.options.characterId)").replacingOccurrences(of: "{" + "destinyMembershipId" + "}", with: "\(self.options.destinyMembershipId)").replacingOccurrences(of: "{" + "membershipType" + "}", with: "\(self.options.membershipType)").replacingOccurrences(of: "{" + "vendorHash" + "}", with: "\(self.options.vendorHash)")
            }
        ...
        public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
            ...
            public struct Status200: APIModel {
                ...
                public var response: DestinyResponsesDestinyVendorResponse?

                public var throttleSeconds: Int?

                public init(detailedErrorTrace: String? = nil, errorCode: Int? = nil, errorStatus: String? = nil, message: String? = nil, messageData: [String: String]? = nil, response: DestinyResponsesDestinyVendorResponse? = nil, throttleSeconds: Int? = nil) {
