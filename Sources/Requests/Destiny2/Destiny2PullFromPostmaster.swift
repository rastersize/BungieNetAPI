...
extension BungieNetAPI.Destiny2 {
    ...
    public enum Destiny2PullFromPostmaster {

        public static let service = APIService<Response>(id: "Destiny2.PullFromPostmaster", tag: "Destiny2", method: "POST", path: "/Destiny2/Actions/Items/PullFromPostmaster/", hasBody: true, securityRequirement: SecurityRequirement(type: "oauth2", scopes: ["MoveEquipDestinyItems"]))

        public final class Request: APIRequest<Response> {

            public var body: DestinyRequestsActionsDestinyPostmasterTransferRequest

            public init(body: DestinyRequestsActionsDestinyPostmasterTransferRequest, encoder: RequestEncoder? = nil) {
                self.body = body
                super.init(service: Destiny2PullFromPostmaster.service) { defaultEncoder in
