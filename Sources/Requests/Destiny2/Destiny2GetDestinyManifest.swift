...
extension BungieNetAPI.Destiny2 {
    ...
    public enum Destiny2GetDestinyManifest {

        public static let service = APIService<Response>(id: "Destiny2.GetDestinyManifest", tag: "Destiny2", method: "GET", path: "/Destiny2/Manifest/", hasBody: false)

        public final class Request: APIRequest<Response> {

            public init() {
                super.init(service: Destiny2GetDestinyManifest.service)
            }
        }
        ...
        public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
            ...
            public struct Status200: APIModel {
                ...
                public var response: DestinyConfigDestinyManifest?

                public var throttleSeconds: Int?

                public init(detailedErrorTrace: String? = nil, errorCode: Int? = nil, errorStatus: String? = nil, message: String? = nil, messageData: [String: String]? = nil, response: DestinyConfigDestinyManifest? = nil, throttleSeconds: Int? = nil) {
