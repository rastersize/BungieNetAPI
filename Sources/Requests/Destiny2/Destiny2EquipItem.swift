...
extension BungieNetAPI.Destiny2 {
    ...
    public enum Destiny2EquipItem {

        public static let service = APIService<Response>(id: "Destiny2.EquipItem", tag: "Destiny2", method: "POST", path: "/Destiny2/Actions/Items/EquipItem/", hasBody: true, securityRequirement: SecurityRequirement(type: "oauth2", scopes: ["MoveEquipDestinyItems"]))

        public final class Request: APIRequest<Response> {

            public var body: DestinyRequestsActionsDestinyItemActionRequest

            public init(body: DestinyRequestsActionsDestinyItemActionRequest, encoder: RequestEncoder? = nil) {
                self.body = body
                super.init(service: Destiny2EquipItem.service) { defaultEncoder in
