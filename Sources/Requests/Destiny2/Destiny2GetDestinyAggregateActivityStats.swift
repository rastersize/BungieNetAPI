...
extension BungieNetAPI.Destiny2 {
    ...
    public enum Destiny2GetDestinyAggregateActivityStats {

        public static let service = APIService<Response>(id: "Destiny2.GetDestinyAggregateActivityStats", tag: "Destiny2", method: "GET", path: "/Destiny2/{membershipType}/Account/{destinyMembershipId}/Character/{characterId}/Stats/AggregateActivityStats/", hasBody: false)
        ...
        public final class Request: APIRequest<Response> {
            ...
            public struct Options {
                ...
                public init(characterId: Int, destinyMembershipId: Int, membershipType: Int) {
            ...
            public init(options: Options) {
                ...
                super.init(service: Destiny2GetDestinyAggregateActivityStats.service)
            }

            /// convenience initialiser so an Option doesn't have to be created
            public convenience init(characterId: Int, destinyMembershipId: Int, membershipType: Int) {
                let options = Options(characterId: characterId, destinyMembershipId: destinyMembershipId, membershipType: membershipType)
        ...
        public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
            ...
            public struct Status200: APIModel {
                ...
                public var response: DestinyHistoricalStatsDestinyAggregateActivityResults?

                public var throttleSeconds: Int?

                public init(detailedErrorTrace: String? = nil, errorCode: Int? = nil, errorStatus: String? = nil, message: String? = nil, messageData: [String: String]? = nil, response: DestinyHistoricalStatsDestinyAggregateActivityResults? = nil, throttleSeconds: Int? = nil) {
