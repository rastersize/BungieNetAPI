...
extension BungieNetAPI.Destiny2 {
    ...
    public enum Destiny2TransferItem {

        public static let service = APIService<Response>(id: "Destiny2.TransferItem", tag: "Destiny2", method: "POST", path: "/Destiny2/Actions/Items/TransferItem/", hasBody: true, securityRequirement: SecurityRequirement(type: "oauth2", scopes: ["MoveEquipDestinyItems"]))

        public final class Request: APIRequest<Response> {

            public var body: DestinyRequestsDestinyItemTransferRequest

            public init(body: DestinyRequestsDestinyItemTransferRequest, encoder: RequestEncoder? = nil) {
                self.body = body
                super.init(service: Destiny2TransferItem.service) { defaultEncoder in
