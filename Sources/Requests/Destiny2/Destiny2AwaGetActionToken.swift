...
extension BungieNetAPI.Destiny2 {
    ...
    public enum Destiny2AwaGetActionToken {

        public static let service = APIService<Response>(id: "Destiny2.AwaGetActionToken", tag: "Destiny2", method: "GET", path: "/Destiny2/Awa/GetActionToken/{correlationId}/", hasBody: false, securityRequirement: SecurityRequirement(type: "oauth2", scopes: ["AdvancedWriteActions"]))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: Destiny2AwaGetActionToken.service)
            }

            /// convenience initialiser so an Option doesn't have to be created
            public convenience init(correlationId: String) {
                let options = Options(correlationId: correlationId)
                self.init(options: options)
            }

            public override var path: String {
                return super.path.replacingOccurrences(of: "{" + "correlationId" + "}", with: "\(self.options.correlationId)")
            }
        }
        ...
        public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
            ...
            public struct Status200: APIModel {
                ...
                public var response: DestinyAdvancedAwaAuthorizationResult?

                public var throttleSeconds: Int?

                public init(detailedErrorTrace: String? = nil, errorCode: Int? = nil, errorStatus: String? = nil, message: String? = nil, messageData: [String: String]? = nil, response: DestinyAdvancedAwaAuthorizationResult? = nil, throttleSeconds: Int? = nil) {
