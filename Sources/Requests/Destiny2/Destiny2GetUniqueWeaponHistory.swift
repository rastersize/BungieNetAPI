...
extension BungieNetAPI.Destiny2 {
    ...
    public enum Destiny2GetUniqueWeaponHistory {

        public static let service = APIService<Response>(id: "Destiny2.GetUniqueWeaponHistory", tag: "Destiny2", method: "GET", path: "/Destiny2/{membershipType}/Account/{destinyMembershipId}/Character/{characterId}/Stats/UniqueWeapons/", hasBody: false)
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: Destiny2GetUniqueWeaponHistory.service)
            }
        ...
        public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
            ...
            public struct Status200: APIModel {
                ...
                public var response: DestinyHistoricalStatsDestinyHistoricalWeaponStatsData?

                public var throttleSeconds: Int?

                public init(detailedErrorTrace: String? = nil, errorCode: Int? = nil, errorStatus: String? = nil, message: String? = nil, messageData: [String: String]? = nil, response: DestinyHistoricalStatsDestinyHistoricalWeaponStatsData? = nil, throttleSeconds: Int? = nil) {
