...
extension BungieNetAPI.Destiny2 {
    ...
    public enum Destiny2SearchDestinyPlayer {

        public static let service = APIService<Response>(id: "Destiny2.SearchDestinyPlayer", tag: "Destiny2", method: "GET", path: "/Destiny2/SearchDestinyPlayer/{membershipType}/{displayName}/", hasBody: false)
        ...
        public final class Request: APIRequest<Response> {
            ...
            public struct Options {
                ...
                public var returnOriginalProfile: Bool?

                public init(displayName: String, membershipType: Int, returnOriginalProfile: Bool? = nil) {
                    self.displayName = displayName
                    self.membershipType = membershipType
                    self.returnOriginalProfile = returnOriginalProfile
                }
            }
            ...
            public init(options: Options) {
                ...
                super.init(service: Destiny2SearchDestinyPlayer.service)
            }

            /// convenience initialiser so an Option doesn't have to be created
            public convenience init(displayName: String, membershipType: Int, returnOriginalProfile: Bool? = nil) {
                let options = Options(displayName: displayName, membershipType: membershipType, returnOriginalProfile: returnOriginalProfile)
                self.init(options: options)
            }

            public override var path: String {
                return super.path.replacingOccurrences(of: "{" + "displayName" + "}", with: "\(self.options.displayName)").replacingOccurrences(of: "{" + "membershipType" + "}", with: "\(self.options.membershipType)")
            }

            public override var queryParameters: [String: Any] {
                var params: [String: Any] = [:]
                if let returnOriginalProfile = options.returnOriginalProfile {
        ...
        public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
            ...
            public struct Status200: APIModel {
                ...
                public var response: [UserUserInfoCard]?

                public var throttleSeconds: Int?

                public init(detailedErrorTrace: String? = nil, errorCode: Int? = nil, errorStatus: String? = nil, message: String? = nil, messageData: [String: String]? = nil, response: [UserUserInfoCard]? = nil, throttleSeconds: Int? = nil) {
