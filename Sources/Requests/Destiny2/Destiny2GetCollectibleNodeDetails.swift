...
extension BungieNetAPI.Destiny2 {
    ...
    public enum Destiny2GetCollectibleNodeDetails {

        public static let service = APIService<Response>(id: "Destiny2.GetCollectibleNodeDetails", tag: "Destiny2", method: "GET", path: "/Destiny2/{membershipType}/Profile/{destinyMembershipId}/Character/{characterId}/Collectibles/{collectiblePresentationNodeHash}/", hasBody: false)
        ...
        public final class Request: APIRequest<Response> {
            ...
            public struct Options {
                ...
                public var collectiblePresentationNodeHash: Int
                ...
                public init(characterId: Int, collectiblePresentationNodeHash: Int, components: [Int]? = nil, destinyMembershipId: Int, membershipType: Int) {
                    self.characterId = characterId
                    self.collectiblePresentationNodeHash = collectiblePresentationNodeHash
            ...
            public init(options: Options) {
                ...
                super.init(service: Destiny2GetCollectibleNodeDetails.service)
            }

            /// convenience initialiser so an Option doesn't have to be created
            public convenience init(characterId: Int, collectiblePresentationNodeHash: Int, components: [Int]? = nil, destinyMembershipId: Int, membershipType: Int) {
                let options = Options(characterId: characterId, collectiblePresentationNodeHash: collectiblePresentationNodeHash, components: components, destinyMembershipId: destinyMembershipId, membershipType: membershipType)
                self.init(options: options)
            }

            public override var path: String {
                return super.path.replacingOccurrences(of: "{" + "characterId" + "}", with: "\(self.options.characterId)").replacingOccurrences(of: "{" + "collectiblePresentationNodeHash" + "}", with: "\(self.options.collectiblePresentationNodeHash)").replacingOccurrences(of: "{" + "destinyMembershipId" + "}", with: "\(self.options.destinyMembershipId)").replacingOccurrences(of: "{" + "membershipType" + "}", with: "\(self.options.membershipType)")
            }
        ...
        public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
            ...
            public struct Status200: APIModel {
                ...
                public var response: DestinyResponsesDestinyCollectibleNodeDetailResponse?

                public var throttleSeconds: Int?

                public init(detailedErrorTrace: String? = nil, errorCode: Int? = nil, errorStatus: String? = nil, message: String? = nil, messageData: [String: String]? = nil, response: DestinyResponsesDestinyCollectibleNodeDetailResponse? = nil, throttleSeconds: Int? = nil) {
