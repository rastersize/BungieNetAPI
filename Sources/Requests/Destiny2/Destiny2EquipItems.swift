...
extension BungieNetAPI.Destiny2 {
    ...
    public enum Destiny2EquipItems {

        public static let service = APIService<Response>(id: "Destiny2.EquipItems", tag: "Destiny2", method: "POST", path: "/Destiny2/Actions/Items/EquipItems/", hasBody: true, securityRequirement: SecurityRequirement(type: "oauth2", scopes: ["MoveEquipDestinyItems"]))

        public final class Request: APIRequest<Response> {

            public var body: DestinyRequestsActionsDestinyItemSetActionRequest

            public init(body: DestinyRequestsActionsDestinyItemSetActionRequest, encoder: RequestEncoder? = nil) {
                self.body = body
                super.init(service: Destiny2EquipItems.service) { defaultEncoder in
        ...
        public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
            ...
            public struct Status200: APIModel {
                ...
                public var response: DestinyDestinyEquipItemResults?

                public var throttleSeconds: Int?

                public init(detailedErrorTrace: String? = nil, errorCode: Int? = nil, errorStatus: String? = nil, message: String? = nil, messageData: [String: String]? = nil, response: DestinyDestinyEquipItemResults? = nil, throttleSeconds: Int? = nil) {
