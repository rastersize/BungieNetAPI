...
extension BungieNetAPI.Destiny2 {
    ...
    public enum Destiny2GetActivityHistory {

        public static let service = APIService<Response>(id: "Destiny2.GetActivityHistory", tag: "Destiny2", method: "GET", path: "/Destiny2/{membershipType}/Account/{destinyMembershipId}/Character/{characterId}/Stats/Activities/", hasBody: false)
        ...
        public final class Request: APIRequest<Response> {
            ...
            public struct Options {
                ...
                public init(characterId: Int, count: Int? = nil, destinyMembershipId: Int, membershipType: Int, mode: Int? = nil, page: Int? = nil) {
            ...
            public init(options: Options) {
                ...
                super.init(service: Destiny2GetActivityHistory.service)
            }

            /// convenience initialiser so an Option doesn't have to be created
            public convenience init(characterId: Int, count: Int? = nil, destinyMembershipId: Int, membershipType: Int, mode: Int? = nil, page: Int? = nil) {
                let options = Options(characterId: characterId, count: count, destinyMembershipId: destinyMembershipId, membershipType: membershipType, mode: mode, page: page)
        ...
        public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
            ...
            public struct Status200: APIModel {
                ...
                public var response: DestinyHistoricalStatsDestinyActivityHistoryResults?

                public var throttleSeconds: Int?

                public init(detailedErrorTrace: String? = nil, errorCode: Int? = nil, errorStatus: String? = nil, message: String? = nil, messageData: [String: String]? = nil, response: DestinyHistoricalStatsDestinyActivityHistoryResults? = nil, throttleSeconds: Int? = nil) {
