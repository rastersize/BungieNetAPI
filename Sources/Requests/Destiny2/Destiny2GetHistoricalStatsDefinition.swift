...
extension BungieNetAPI.Destiny2 {
    ...
    public enum Destiny2GetHistoricalStatsDefinition {

        public static let service = APIService<Response>(id: "Destiny2.GetHistoricalStatsDefinition", tag: "Destiny2", method: "GET", path: "/Destiny2/Stats/Definition/", hasBody: false)

        public final class Request: APIRequest<Response> {

            public init() {
                super.init(service: Destiny2GetHistoricalStatsDefinition.service)
            }
        }
        ...
        public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
            ...
            public struct Status200: APIModel {
                ...
                public var response: [String: DestinyHistoricalStatsDefinitionsDestinyHistoricalStatsDefinition]?

                public var throttleSeconds: Int?

                public init(detailedErrorTrace: String? = nil, errorCode: Int? = nil, errorStatus: String? = nil, message: String? = nil, messageData: [String: String]? = nil, response: [String: DestinyHistoricalStatsDefinitionsDestinyHistoricalStatsDefinition]? = nil, throttleSeconds: Int? = nil) {
