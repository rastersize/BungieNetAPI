...
extension BungieNetAPI.Destiny2 {
    ...
    public enum Destiny2GetPostGameCarnageReport {

        public static let service = APIService<Response>(id: "Destiny2.GetPostGameCarnageReport", tag: "Destiny2", method: "GET", path: "/Destiny2/Stats/PostGameCarnageReport/{activityId}/", hasBody: false)
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: Destiny2GetPostGameCarnageReport.service)
            }

            /// convenience initialiser so an Option doesn't have to be created
            public convenience init(activityId: Int) {
        ...
        public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
            ...
            public struct Status200: APIModel {
                ...
                public var response: DestinyHistoricalStatsDestinyPostGameCarnageReportData?

                public var throttleSeconds: Int?

                public init(detailedErrorTrace: String? = nil, errorCode: Int? = nil, errorStatus: String? = nil, message: String? = nil, messageData: [String: String]? = nil, response: DestinyHistoricalStatsDestinyPostGameCarnageReportData? = nil, throttleSeconds: Int? = nil) {
