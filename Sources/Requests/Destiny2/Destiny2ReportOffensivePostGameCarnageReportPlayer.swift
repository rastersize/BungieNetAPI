...
extension BungieNetAPI.Destiny2 {
    ...
    public enum Destiny2ReportOffensivePostGameCarnageReportPlayer {

        public static let service = APIService<Response>(id: "Destiny2.ReportOffensivePostGameCarnageReportPlayer", tag: "Destiny2", method: "POST", path: "/Destiny2/Stats/PostGameCarnageReport/{activityId}/Report/", hasBody: true, securityRequirement: SecurityRequirement(type: "oauth2", scopes: ["BnetWrite"]))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public var body: DestinyReportingRequestsDestinyReportOffensePgcrRequest

            public init(body: DestinyReportingRequestsDestinyReportOffensePgcrRequest, options: Options, encoder: RequestEncoder? = nil) {
                self.body = body
                self.options = options
                super.init(service: Destiny2ReportOffensivePostGameCarnageReportPlayer.service) { defaultEncoder in
                    return try (encoder ?? defaultEncoder).encode(body)
                }
            }

            /// convenience initialiser so an Option doesn't have to be created
            public convenience init(activityId: Int, body: DestinyReportingRequestsDestinyReportOffensePgcrRequest) {
                let options = Options(activityId: activityId)
                self.init(body: body, options: options)
            }

            public override var path: String {
                return super.path.replacingOccurrences(of: "{" + "activityId" + "}", with: "\(self.options.activityId)")
            }
        }
