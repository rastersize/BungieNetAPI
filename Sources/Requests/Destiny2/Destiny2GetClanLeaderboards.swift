...
extension BungieNetAPI.Destiny2 {
    ...
    public enum Destiny2GetClanLeaderboards {

        public static let service = APIService<Response>(id: "Destiny2.GetClanLeaderboards", tag: "Destiny2", method: "GET", path: "/Destiny2/Stats/Leaderboards/Clans/{groupId}/", hasBody: false)
        ...
        public final class Request: APIRequest<Response> {
            ...
            public struct Options {
                ...
                public init(groupId: Int, maxtop: Int? = nil, modes: String? = nil, statid: String? = nil) {
            ...
            public init(options: Options) {
                ...
                super.init(service: Destiny2GetClanLeaderboards.service)
            }

            /// convenience initialiser so an Option doesn't have to be created
            public convenience init(groupId: Int, maxtop: Int? = nil, modes: String? = nil, statid: String? = nil) {
                let options = Options(groupId: groupId, maxtop: maxtop, modes: modes, statid: statid)
