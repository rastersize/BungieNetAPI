...
extension BungieNetAPI.Destiny2 {
    ...
    public enum Destiny2GetLinkedProfiles {

        public static let service = APIService<Response>(id: "Destiny2.GetLinkedProfiles", tag: "Destiny2", method: "GET", path: "/Destiny2/{membershipType}/Profile/{membershipId}/LinkedProfiles/", hasBody: false)
        ...
        public final class Request: APIRequest<Response> {
            ...
            public struct Options {
                ...
                public var getAllMemberships: Bool?
                ...
                public init(getAllMemberships: Bool? = nil, membershipId: Int, membershipType: Int) {
            ...
            public init(options: Options) {
                ...
                super.init(service: Destiny2GetLinkedProfiles.service)
            }

            /// convenience initialiser so an Option doesn't have to be created
            public convenience init(getAllMemberships: Bool? = nil, membershipId: Int, membershipType: Int) {
                let options = Options(getAllMemberships: getAllMemberships, membershipId: membershipId, membershipType: membershipType)
                self.init(options: options)
            }

            public override var path: String {
                return super.path.replacingOccurrences(of: "{" + "membershipId" + "}", with: "\(self.options.membershipId)").replacingOccurrences(of: "{" + "membershipType" + "}", with: "\(self.options.membershipType)")
            }

            public override var queryParameters: [String: Any] {
                var params: [String: Any] = [:]
                if let getAllMemberships = options.getAllMemberships {
        ...
        public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
            ...
            public struct Status200: APIModel {
                ...
                public var response: DestinyResponsesDestinyLinkedProfilesResponse?

                public var throttleSeconds: Int?

                public init(detailedErrorTrace: String? = nil, errorCode: Int? = nil, errorStatus: String? = nil, message: String? = nil, messageData: [String: String]? = nil, response: DestinyResponsesDestinyLinkedProfilesResponse? = nil, throttleSeconds: Int? = nil) {
