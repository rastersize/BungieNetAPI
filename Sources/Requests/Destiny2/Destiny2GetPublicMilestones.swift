...
extension BungieNetAPI.Destiny2 {
    ...
    public enum Destiny2GetPublicMilestones {

        public static let service = APIService<Response>(id: "Destiny2.GetPublicMilestones", tag: "Destiny2", method: "GET", path: "/Destiny2/Milestones/", hasBody: false)

        public final class Request: APIRequest<Response> {

            public init() {
                super.init(service: Destiny2GetPublicMilestones.service)
            }
        }
        ...
        public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
            ...
            public struct Status200: APIModel {
                ...
                public var response: [String: DestinyMilestonesDestinyPublicMilestone]?

                public var throttleSeconds: Int?

                public init(detailedErrorTrace: String? = nil, errorCode: Int? = nil, errorStatus: String? = nil, message: String? = nil, messageData: [String: String]? = nil, response: [String: DestinyMilestonesDestinyPublicMilestone]? = nil, throttleSeconds: Int? = nil) {
