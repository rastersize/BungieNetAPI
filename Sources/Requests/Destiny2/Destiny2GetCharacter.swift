...
extension BungieNetAPI.Destiny2 {
    ...
    public enum Destiny2GetCharacter {

        public static let service = APIService<Response>(id: "Destiny2.GetCharacter", tag: "Destiny2", method: "GET", path: "/Destiny2/{membershipType}/Profile/{destinyMembershipId}/Character/{characterId}/", hasBody: false)
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: Destiny2GetCharacter.service)
            }
        ...
        public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
            ...
            public struct Status200: APIModel {
                ...
                public var response: DestinyResponsesDestinyCharacterResponse?

                public var throttleSeconds: Int?

                public init(detailedErrorTrace: String? = nil, errorCode: Int? = nil, errorStatus: String? = nil, message: String? = nil, messageData: [String: String]? = nil, response: DestinyResponsesDestinyCharacterResponse? = nil, throttleSeconds: Int? = nil) {
