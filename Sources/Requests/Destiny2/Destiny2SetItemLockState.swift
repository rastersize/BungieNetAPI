...
extension BungieNetAPI.Destiny2 {
    ...
    public enum Destiny2SetItemLockState {

        public static let service = APIService<Response>(id: "Destiny2.SetItemLockState", tag: "Destiny2", method: "POST", path: "/Destiny2/Actions/Items/SetLockState/", hasBody: true, securityRequirement: SecurityRequirement(type: "oauth2", scopes: ["MoveEquipDestinyItems"]))

        public final class Request: APIRequest<Response> {

            public var body: DestinyRequestsActionsDestinyItemStateRequest

            public init(body: DestinyRequestsActionsDestinyItemStateRequest, encoder: RequestEncoder? = nil) {
                self.body = body
                super.init(service: Destiny2SetItemLockState.service) { defaultEncoder in
