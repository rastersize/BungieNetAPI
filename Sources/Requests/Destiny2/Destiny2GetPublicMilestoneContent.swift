...
extension BungieNetAPI.Destiny2 {
    ...
    public enum Destiny2GetPublicMilestoneContent {

        public static let service = APIService<Response>(id: "Destiny2.GetPublicMilestoneContent", tag: "Destiny2", method: "GET", path: "/Destiny2/Milestones/{milestoneHash}/Content/", hasBody: false)
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: Destiny2GetPublicMilestoneContent.service)
            }

            /// convenience initialiser so an Option doesn't have to be created
            public convenience init(milestoneHash: Int) {
                let options = Options(milestoneHash: milestoneHash)
                self.init(options: options)
            }

            public override var path: String {
                return super.path.replacingOccurrences(of: "{" + "milestoneHash" + "}", with: "\(self.options.milestoneHash)")
            }
        }
        ...
        public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
            ...
            public struct Status200: APIModel {
                ...
                public var response: DestinyMilestonesDestinyMilestoneContent?

                public var throttleSeconds: Int?

                public init(detailedErrorTrace: String? = nil, errorCode: Int? = nil, errorStatus: String? = nil, message: String? = nil, messageData: [String: String]? = nil, response: DestinyMilestonesDestinyMilestoneContent? = nil, throttleSeconds: Int? = nil) {
