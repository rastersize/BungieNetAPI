...
extension BungieNetAPI.Destiny2 {
    ...
    public enum Destiny2AwaInitializeRequest {

        public static let service = APIService<Response>(id: "Destiny2.AwaInitializeRequest", tag: "Destiny2", method: "POST", path: "/Destiny2/Awa/Initialize/", hasBody: true, securityRequirement: SecurityRequirement(type: "oauth2", scopes: ["AdvancedWriteActions"]))

        public final class Request: APIRequest<Response> {

            public var body: DestinyAdvancedAwaPermissionRequested

            public init(body: DestinyAdvancedAwaPermissionRequested, encoder: RequestEncoder? = nil) {
                self.body = body
                super.init(service: Destiny2AwaInitializeRequest.service) { defaultEncoder in
        ...
        public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
            ...
            public struct Status200: APIModel {
                ...
                public var response: DestinyAdvancedAwaInitializeResponse?

                public var throttleSeconds: Int?

                public init(detailedErrorTrace: String? = nil, errorCode: Int? = nil, errorStatus: String? = nil, message: String? = nil, messageData: [String: String]? = nil, response: DestinyAdvancedAwaInitializeResponse? = nil, throttleSeconds: Int? = nil) {
