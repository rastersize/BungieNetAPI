...
extension BungieNetAPI.Content {
    ...
    public enum ContentGetContentByTagAndType {

        public static let service = APIService<Response>(id: "Content.GetContentByTagAndType", tag: "Content", method: "GET", path: "/Content/GetContentByTagAndType/{tag}/{type}/{locale}/", hasBody: false)
        ...
        public final class Request: APIRequest<Response> {
            ...
            public struct Options {
                ...
                public init(head: Bool? = nil, locale: String, tag: String, type: String) {
                    self.head = head
                    self.locale = locale
                    self.tag = tag
                    self.type = type
            ...
            public init(options: Options) {
                ...
                super.init(service: ContentGetContentByTagAndType.service)
            }

            /// convenience initialiser so an Option doesn't have to be created
            public convenience init(head: Bool? = nil, locale: String, tag: String, type: String) {
                let options = Options(head: head, locale: locale, tag: tag, type: type)
        ...
        public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
            ...
            public struct Status200: APIModel {
                ...
                public var response: ContentContentItemPublicContract?

                public var throttleSeconds: Int?

                public init(detailedErrorTrace: String? = nil, errorCode: Int? = nil, errorStatus: String? = nil, message: String? = nil, messageData: [String: String]? = nil, response: ContentContentItemPublicContract? = nil, throttleSeconds: Int? = nil) {
