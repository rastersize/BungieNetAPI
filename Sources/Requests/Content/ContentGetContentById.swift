...
extension BungieNetAPI.Content {
    ...
    public enum ContentGetContentById {

        public static let service = APIService<Response>(id: "Content.GetContentById", tag: "Content", method: "GET", path: "/Content/GetContentById/{id}/{locale}/", hasBody: false)
        ...
        public final class Request: APIRequest<Response> {
            ...
            public struct Options {
                ...
                public init(head: Bool? = nil, id: Int, locale: String) {
                    self.head = head
                    self.id = id
                    self.locale = locale
                }
            ...
            public init(options: Options) {
                ...
                super.init(service: ContentGetContentById.service)
            }

            /// convenience initialiser so an Option doesn't have to be created
            public convenience init(head: Bool? = nil, id: Int, locale: String) {
                let options = Options(head: head, id: id, locale: locale)
                self.init(options: options)
            }

            public override var path: String {
                return super.path.replacingOccurrences(of: "{" + "id" + "}", with: "\(self.options.id)").replacingOccurrences(of: "{" + "locale" + "}", with: "\(self.options.locale)")
            }
