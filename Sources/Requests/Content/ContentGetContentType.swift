...
extension BungieNetAPI.Content {
    ...
    public enum ContentGetContentType {

        public static let service = APIService<Response>(id: "Content.GetContentType", tag: "Content", method: "GET", path: "/Content/GetContentType/{type}/", hasBody: false)
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: ContentGetContentType.service)
            }
        ...
        public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
            ...
            public struct Status200: APIModel {
                ...
                public var response: ContentModelsContentTypeDescription?

                public var throttleSeconds: Int?

                public init(detailedErrorTrace: String? = nil, errorCode: Int? = nil, errorStatus: String? = nil, message: String? = nil, messageData: [String: String]? = nil, response: ContentModelsContentTypeDescription? = nil, throttleSeconds: Int? = nil) {
