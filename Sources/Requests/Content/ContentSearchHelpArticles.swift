...
extension BungieNetAPI.Content {
    ...
    public enum ContentSearchHelpArticles {

        public static let service = APIService<Response>(id: "Content.SearchHelpArticles", tag: "Content", method: "GET", path: "/Content/SearchHelpArticles/{searchtext}/{size}", hasBody: false)
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: ContentSearchHelpArticles.service)
            }

            /// convenience initialiser so an Option doesn't have to be created
            public convenience init(searchtext: String, size: String) {
                let options = Options(searchtext: searchtext, size: size)
                self.init(options: options)
            }

            public override var path: String {
                return super.path.replacingOccurrences(of: "{" + "searchtext" + "}", with: "\(self.options.searchtext)").replacingOccurrences(of: "{" + "size" + "}", with: "\(self.options.size)")
            }
        }
        ...
        public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
            ...
            public struct Status200: APIModel {
                ...
                public init(detailedErrorTrace: String? = nil, errorCode: Int? = nil, errorStatus: String? = nil, message: String? = nil, messageData: [String: String]? = nil, response: [String: Any]? = nil, throttleSeconds: Int? = nil) {
                ...
                public init(from decoder: Decoder) throws {
                    ...
                    response = try container.decodeAnyIfPresent("Response")
                ...
                public func encode(to encoder: Encoder) throws {
                    ...
                    try container.encodeAnyIfPresent(response, forKey: "Response")
                ...
                public static func == (lhs: Status200, rhs: Status200) -> Bool {
                    ...
                    guard NSDictionary(dictionary: lhs.response ?? [:]).isEqual(to: rhs.response ?? [:]) else { return false }
