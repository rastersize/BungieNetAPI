...
extension BungieNetAPI.Forum {
    ...
    public enum ForumGetPoll {

        public static let service = APIService<Response>(id: "Forum.GetPoll", tag: "Forum", method: "GET", path: "/Forum/Poll/{topicId}/", hasBody: false)
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: ForumGetPoll.service)
            }

            /// convenience initialiser so an Option doesn't have to be created
            public convenience init(topicId: Int) {
                let options = Options(topicId: topicId)
                self.init(options: options)
            }

            public override var path: String {
                return super.path.replacingOccurrences(of: "{" + "topicId" + "}", with: "\(self.options.topicId)")
            }
        }
