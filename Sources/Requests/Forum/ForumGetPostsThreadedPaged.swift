...
extension BungieNetAPI.Forum {
    ...
    public enum ForumGetPostsThreadedPaged {

        public static let service = APIService<Response>(id: "Forum.GetPostsThreadedPaged", tag: "Forum", method: "GET", path: "/Forum/GetPostsThreadedPaged/{parentPostId}/{page}/{pageSize}/{replySize}/{getParentPost}/{rootThreadMode}/{sortMode}/", hasBody: false)

        public final class Request: APIRequest<Response> {

            public struct Options {

                public var getParentPost: Bool

                public var page: Int

                public var pageSize: Int

                public var parentPostId: Int
                ...
                public init(getParentPost: Bool, page: Int, pageSize: Int, parentPostId: Int, replySize: Int, rootThreadMode: Bool, showbanned: String? = nil, sortMode: Int) {
                    self.getParentPost = getParentPost
                    self.page = page
            ...
            public init(options: Options) {
                ...
                super.init(service: ForumGetPostsThreadedPaged.service)
            }

            /// convenience initialiser so an Option doesn't have to be created
            public convenience init(getParentPost: Bool, page: Int, pageSize: Int, parentPostId: Int, replySize: Int, rootThreadMode: Bool, showbanned: String? = nil, sortMode: Int) {
                let options = Options(getParentPost: getParentPost, page: page, pageSize: pageSize, parentPostId: parentPostId, replySize: replySize, rootThreadMode: rootThreadMode, showbanned: showbanned, sortMode: sortMode)
                self.init(options: options)
            }

            public override var path: String {
                return super.path.replacingOccurrences(of: "{" + "getParentPost" + "}", with: "\(self.options.getParentPost)").replacingOccurrences(of: "{" + "page" + "}", with: "\(self.options.page)").replacingOccurrences(of: "{" + "pageSize" + "}", with: "\(self.options.pageSize)").replacingOccurrences(of: "{" + "parentPostId" + "}", with: "\(self.options.parentPostId)").replacingOccurrences(of: "{" + "replySize" + "}", with: "\(self.options.replySize)").replacingOccurrences(of: "{" + "rootThreadMode" + "}", with: "\(self.options.rootThreadMode)").replacingOccurrences(of: "{" + "sortMode" + "}", with: "\(self.options.sortMode)")
            }
