...
extension BungieNetAPI.Forum {
    ...
    public enum ForumGetPostAndParent {

        public static let service = APIService<Response>(id: "Forum.GetPostAndParent", tag: "Forum", method: "GET", path: "/Forum/GetPostAndParent/{childPostId}/", hasBody: false)
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: ForumGetPostAndParent.service)
            }
