...
extension BungieNetAPI.Forum {
    ...
    public enum ForumGetRecruitmentThreadSummaries {

        public static let service = APIService<Response>(id: "Forum.GetRecruitmentThreadSummaries", tag: "Forum", method: "POST", path: "/Forum/Recruit/Summaries/", hasBody: true)

        public final class Request: APIRequest<Response> {

            public var body: [Int]

            public init(body: [Int], encoder: RequestEncoder? = nil) {
                self.body = body
                super.init(service: ForumGetRecruitmentThreadSummaries.service) { defaultEncoder in
        ...
        public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
            ...
            public struct Status200: APIModel {
                ...
                public var response: [ForumForumRecruitmentDetail]?

                public var throttleSeconds: Int?

                public init(detailedErrorTrace: String? = nil, errorCode: Int? = nil, errorStatus: String? = nil, message: String? = nil, messageData: [String: String]? = nil, response: [ForumForumRecruitmentDetail]? = nil, throttleSeconds: Int? = nil) {
