...
extension BungieNetAPI.Forum {
    ...
    public enum ForumGetTopicForContent {

        public static let service = APIService<Response>(id: "Forum.GetTopicForContent", tag: "Forum", method: "GET", path: "/Forum/GetTopicForContent/{contentId}/", hasBody: false)
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: ForumGetTopicForContent.service)
            }

            /// convenience initialiser so an Option doesn't have to be created
            public convenience init(contentId: Int) {
                let options = Options(contentId: contentId)
                self.init(options: options)
            }

            public override var path: String {
                return super.path.replacingOccurrences(of: "{" + "contentId" + "}", with: "\(self.options.contentId)")
            }
        }
