...
extension BungieNetAPI.Forum {
    ...
    public enum ForumGetPostAndParentAwaitingApproval {

        public static let service = APIService<Response>(id: "Forum.GetPostAndParentAwaitingApproval", tag: "Forum", method: "GET", path: "/Forum/GetPostAndParentAwaitingApproval/{childPostId}/", hasBody: false)
        ...
        public final class Request: APIRequest<Response> {
            ...
            public struct Options {
                ...
                public init(childPostId: Int, showbanned: String? = nil) {
            ...
            public init(options: Options) {
                ...
                super.init(service: ForumGetPostAndParentAwaitingApproval.service)
            }

            /// convenience initialiser so an Option doesn't have to be created
            public convenience init(childPostId: Int, showbanned: String? = nil) {
                let options = Options(childPostId: childPostId, showbanned: showbanned)
                self.init(options: options)
            }

            public override var path: String {
                return super.path.replacingOccurrences(of: "{" + "childPostId" + "}", with: "\(self.options.childPostId)")
            }
