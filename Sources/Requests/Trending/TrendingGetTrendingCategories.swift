...
extension BungieNetAPI.Trending {
    ...
    public enum TrendingGetTrendingCategories {

        public static let service = APIService<Response>(id: "Trending.GetTrendingCategories", tag: "Trending", method: "GET", path: "/Trending/Categories/", hasBody: false)

        public final class Request: APIRequest<Response> {

            public init() {
                super.init(service: TrendingGetTrendingCategories.service)
            }
        }
        ...
        public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
            ...
            public struct Status200: APIModel {
                ...
                public var response: TrendingTrendingCategories?

                public var throttleSeconds: Int?

                public init(detailedErrorTrace: String? = nil, errorCode: Int? = nil, errorStatus: String? = nil, message: String? = nil, messageData: [String: String]? = nil, response: TrendingTrendingCategories? = nil, throttleSeconds: Int? = nil) {
