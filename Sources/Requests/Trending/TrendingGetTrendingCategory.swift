...
extension BungieNetAPI.Trending {
    ...
    public enum TrendingGetTrendingCategory {

        public static let service = APIService<Response>(id: "Trending.GetTrendingCategory", tag: "Trending", method: "GET", path: "/Trending/Categories/{categoryId}/{pageNumber}/", hasBody: false)
        ...
        public final class Request: APIRequest<Response> {
            ...
            public struct Options {
                ...
                public init(categoryId: String, pageNumber: Int) {
            ...
            public init(options: Options) {
                ...
                super.init(service: TrendingGetTrendingCategory.service)
            }

            /// convenience initialiser so an Option doesn't have to be created
            public convenience init(categoryId: String, pageNumber: Int) {
                let options = Options(categoryId: categoryId, pageNumber: pageNumber)
                self.init(options: options)
            }

            public override var path: String {
                return super.path.replacingOccurrences(of: "{" + "categoryId" + "}", with: "\(self.options.categoryId)").replacingOccurrences(of: "{" + "pageNumber" + "}", with: "\(self.options.pageNumber)")
            }
        }
        ...
        public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
            ...
            public struct Status200: APIModel {
                ...
                public var response: SearchResultOfTrendingEntry?

                public var throttleSeconds: Int?

                public init(detailedErrorTrace: String? = nil, errorCode: Int? = nil, errorStatus: String? = nil, message: String? = nil, messageData: [String: String]? = nil, response: SearchResultOfTrendingEntry? = nil, throttleSeconds: Int? = nil) {
